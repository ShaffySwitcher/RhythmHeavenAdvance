...
.balign 4, 0 \n\
\n\
glabel func_08041744 \n\
/* 08041744 */ PUSH {R4-R7, LR} \n\
/* 08041746 */ ADDS R5, R0, 0x0 @ Set R5 to R0 + 0x0 \n\
/* 08041748 */ LDR R0, =0x030055d0 @ !PossiblePointer \n\
/* 0804174a */ LDR R0, [R0] \n\
/* 0804174c */ LDR R1, =0x000002e9 @ !PossiblePointer \n\
...
/* 08041754 */ LSLS R7, R5, 0x10 \n\
 \n\
branch_08041756: \n\
/* 08041756 */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 08041758 */ LDR R0, [R0] \n\
/* 0804175a */ LDR R6, =0x030055d0 @ !PossiblePointer \n\
/* 0804175c */ LDR R2, [R6] \n\
...
/* 08041792 */ LDR R3, =0x000002e9 @ !PossiblePointer \n\
