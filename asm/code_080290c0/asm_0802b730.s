...
/* 0802b738 */ LDR R4, =0x030055d0 @ !PossiblePointer \n\
/* 0802b73a */ LDR R0, [R4] \n\
...
/* 0802b756 */ LDR R0, =0x03004afc @ !PossiblePointer \n\
/* 0802b758 */ LDRH R1, [R0] \n\
...
branch_0802b764: \n\
/* 0802b764 */ LDR R0, [R4] \n\
/* 0802b766 */ LDR R1, =0x00000555 @ !PossiblePointer \n\
...
/* 0802b77a */ LDR R4, =0x089e3410 @ !PossiblePointer \n\
...
/* 0802b79c */ LDR R4, =0x089e3478 @ !PossiblePointer \n\
...
/* 0802b7be */ LDR R4, =0x089e349c @ !PossiblePointer \n\
...
/* 0802b7e0 */ LDR R4, =0x089e3528 @ !PossiblePointer \n\
...
/* 0802b80a */ LDR R0, =0x089e3538 @ !PossiblePointer \n\
...
/* 0802b836 */ LDR R4, =0x089e33ec @ !PossiblePointer \n\
...
/* 0802b858 */ LDR R4, =0x089e3444 @ !PossiblePointer \n\
...
/* 0802b87a */ LDR R4, =0x089e349c @ !PossiblePointer \n\
...
/* 0802b89c */ LDR R4, [PC, 0x4C] @ 0x0802b8ec \n\
...
/* 0802b8c4 */ BGE branch_0802b8f0 \n\
 \n\
branch_0802b8c6: \n\
/* 0802b8c6 */ LDR R4, =0x089e349c @ !PossiblePointer \n\
...
\n\
.ltorg \n\
/* 0802b8ec */ ADDS R5, 0x28 @ Add 0x28 to R5 \n\
/* 0802b8ee */ LSRS R6, R3, 0x2 \n\
 \n\
branch_0802b8f0: \n\
/* 0802b8f0 */ LDR R0, =0x089e3538 @ !PossiblePointer \n\
...
.ltorg \n\
 \n\
branch_0802b914: \n\
/* 0802b914 */ LDR R0, =0x089e3538 @ !PossiblePointer \n\
...
/* 0802b92a */ LDR R4, =0x030055d0 @ !PossiblePointer \n\
/* 0802b92c */ LDR R2, [R4] \n\
...
branch_0802b950: \n\
/* 0802b950 */ LDR R0, [R4] \n\
/* 0802b952 */ LDR R1, =0x00000554 @ !PossiblePointer \n\
...
/* 0802b960 */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 0802b962 */ LDR R0, [R0] \n\
/* 0802b964 */ MOVS R2, 0x4 @ Set R2 to 0x4 \n\
/* 0802b966 */ LDRSH R1, [R5, R2] \n\
/* 0802b968 */ LDR R2, =0x088ca120 @ !PossiblePointer \n\
...
/* 0802b9a4 */ LDR R4, =0x03005380 @ !PossiblePointer \n\
/* 0802b9a6 */ LDR R0, [R4] \n\
