...
.balign 4, 0 \n\
\n\
glabel func_08040dd8 \n\
/* 08040dd8 */ PUSH {R4-R6, LR} \n\
/* 08040dda */ SUB SP, 0x8 \n\
/* 08040ddc */ LDR R4, =0x030055d0 @ !PossiblePointer \n\
/* 08040dde */ LDR R0, [R4] \n\
...
/* 08040de8 */ STRB R1, [R0] \n\
/* 08040dea */ LDR R0, [R4] \n\
/* 08040dec */ LDR R3, =0x00000306 @ !PossiblePointer \n\
/* 08040dee */ ADDS R1, R0, R3 @ Set R1 to R0 + R3 \n\
/* 08040df0 */ LDRB R1, [R1] \n\
/* 08040df2 */ LDR R2, =0x000002ff @ !PossiblePointer \n\
...
/* 08040e00 */ LDRH R2, [R0] \n\
/* 08040e02 */ LDR R6, =0x00000302 @ !PossiblePointer \n\
/* 08040e04 */ ADDS R0, R1, R6 @ Set R0 to R1 + R6 \n\
/* 08040e06 */ STRH R2, [R0] \n\
/* 08040e08 */ LDR R2, =0x0000030a @ !PossiblePointer \n\
...
/* 08040e26 */ LDRB R1, [R5] \n\
/* 08040e28 */ LDR R3, =0x089e8d9c @ !PossiblePointer \n\
/* 08040e2a */ LDR R5, =0x000002fe @ !PossiblePointer \n\
...
/* 08040e3c */ LDRH R2, [R4] \n\
/* 08040e3e */ STR R2, [SP] \n\
/* 08040e40 */ LDR R2, =0x03004b64 @ !PossiblePointer \n\
/* 08040e42 */ STR R2, [SP, 0x4] \n\
/* 08040e44 */ MOVS R2, 0x2 @ Set R2 to 0x2 \n\
/* 08040e46 */ BL func_08002050 \n\
/* 08040e4a */ LDR R1, =0x08040d91 @ !PossiblePointer \n\
