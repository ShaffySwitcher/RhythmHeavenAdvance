...
/* 0803d9aa */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 0803d9ac */ LDR R0, [R0] \n\
/* 0803d9ae */ LDR R1, =0x030055d0 @ !PossiblePointer \n\
/* 0803d9b0 */ LDR R1, [R1] \n\
...
.ltorg \n\
 \n\
branch_0803d9c8: \n\
/* 0803d9c8 */ LDR R4, =0x030055d0 @ !PossiblePointer \n\
/* 0803d9ca */ LDR R1, [R4] \n\
/* 0803d9cc */ LDR R0, [R1] \n\
...
/* 0803d9e6 */ LDR R5, =0x03005380 @ !PossiblePointer \n\
/* 0803d9e8 */ LDR R0, [R5] \n\
/* 0803d9ea */ LDR R1, [R4] \n\
