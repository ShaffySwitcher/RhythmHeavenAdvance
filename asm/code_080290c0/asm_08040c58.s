...
.balign 4, 0 \n\
\n\
glabel func_08040c58 \n\
/* 08040c58 */ PUSH {LR} \n\
/* 08040c5a */ LDR R1, =0x030055d0 @ !PossiblePointer \n\
/* 08040c5c */ LDR R0, [R1] \n\
/* 08040c5e */ LDR R2, =0x000002fe @ !PossiblePointer \n\
...
/* 08040c70 */ LDR R1, =0x08040c84 @ !PossiblePointer \n\
/* 08040c72 */ ADDS R0, R0, R1 @ Set R0 to R0 + R1 \n\
/* 08040c74 */ LDR R0, [R0] \n\
/* 08040c76 */ MOV PC, R0 @ Set PC to R0 \n\
\n\
.ltorg \n\
.word 0x08040c9c @ !Jumptable \n\
.word 0x08040c9c @ !Jumptable \n\
.word 0x08040c9c @ !Jumptable \n\
.word 0x08040cb8 @ !Jumptable \n\
.word 0x08040ccc @ !Jumptable \n\
.word 0x08040cd6 @ !Jumptable \n\
/* 08040c9c */ LDR R0, [R3] \n\
