...
.balign 4, 0 \n\
\n\
glabel func_08035094 \n\
/* 08035094 */ PUSH {R4-R6, LR} \n\
/* 08035096 */ SUB SP, 0xC \n\
/* 08035098 */ ADDS R1, R0, 0x0 @ Set R1 to R0 + 0x0 \n\
/* 0803509a */ LDR R0, =0x030055d0 @ !PossiblePointer \n\
/* 0803509c */ LDR R0, [R0] \n\
...
/* 080350c6 */ STRB R0, [R5, 0x8] \n\
 \n\
branch_080350c8: \n\
/* 080350c8 */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 080350ca */ LDR R0, [R0] \n\
/* 080350cc */ MOVS R2, 0x0 @ Set R2 to 0x0 \n\
/* 080350ce */ LDRSH R1, [R5, R2] \n\
/* 080350d0 */ LDR R3, =0x089e56b8 @ !PossiblePointer \n\
...
/* 080350f8 */ LDR R4, =0x03005380 @ !PossiblePointer \n\
/* 080350fa */ LDR R0, [R4] \n\
...
/* 0803511c */ LDR R0, =0x08a9ddb4 @ !PossiblePointer \n\
...
/* 08035140 */ LDR R0, =0x030055d0 @ !PossiblePointer \n\
/* 08035142 */ LDR R0, [R0] \n\
