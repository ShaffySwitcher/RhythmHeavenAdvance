...
/* 0802a570 */ LDR R1, =0x030055d0 @ !PossiblePointer \n\
/* 0802a572 */ LDR R0, [R1] \n\
...
/* 0802a582 */ LDR R7, =0x03005380 @ !PossiblePointer \n\
...
/* 0802a5a6 */ STR R1, [SP] \n\
/* 0802a5a8 */ LDR R1, =0x0000490a @ !PossiblePointer \n\
...
/* 0802a5b4 */ LDR R1, =0x088c9ec8 @ !PossiblePointer \n\
...
/* 0802a5c8 */ LDR R1, =0xfffff800 @ !PossiblePointer \n\
...
/* 0802a5d8 */ LDR R2, =0xfffff800 @ !PossiblePointer \n\
...
/* 0802a60a */ LDR R3, [R2] \n\
/* 0802a60c */ LDR R2, =0x00000544 @ !PossiblePointer \n\
...
/* 0802a626 */ LDR R0, =0x030055d0 @ !PossiblePointer \n\
/* 0802a628 */ LDR R2, [R0] \n\
...
/* 0802a636 */ LDR R4, =0x00000544 @ !PossiblePointer \n\
