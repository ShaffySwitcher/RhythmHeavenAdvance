...
.ltorg \n\
 \n\
branch_08037c0c: \n\
/* 08037c0c */ LDR R0, =0x030055d0 @ !PossiblePointer \n\
/* 08037c0e */ LDR R0, [R0] \n\
/* 08037c10 */ LDRH R1, [R0, 0xE] \n\
 \n\
branch_08037c12: \n\
/* 08037c12 */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 08037c14 */ LDR R0, [R0] \n\
/* 08037c16 */ LSLS R1, R1, 0x10 \n\
/* 08037c18 */ ASRS R1, R1, 0x10 \n\
/* 08037c1a */ LDR R3, =0x089e5dc4 @ !PossiblePointer \n\
...
/* 08037c36 */ LDR R0, =0x030055d0 @ !PossiblePointer \n\
/* 08037c38 */ LDR R0, [R0] \n\
...
.ltorg \n\
 \n\
branch_08037c4c: \n\
/* 08037c4c */ LDR R0, =0x030055d0 @ !PossiblePointer \n\
/* 08037c4e */ LDR R0, [R0] \n\
/* 08037c50 */ LDRH R1, [R0, 0x10] \n\
 \n\
branch_08037c52: \n\
/* 08037c52 */ LDR R4, =0x03005380 @ !PossiblePointer \n\
/* 08037c54 */ LDR R0, [R4] \n\
...
/* 08037c60 */ LDR R0, [R4] \n\
/* 08037c62 */ LDR R4, =0x030055d0 @ !PossiblePointer \n\
/* 08037c64 */ LDR R2, [R4] \n\
/* 08037c66 */ MOVS R3, 0xA @ Set R3 to 0xA \n\
/* 08037c68 */ LDRSH R1, [R2, R3] \n\
/* 08037c6a */ LDR R3, =0x089e5dcc @ !PossiblePointer \n\
...
/* 08037c9a */ LDR R0, =0x08a9e264 @ !PossiblePointer \n\
