...
.balign 4, 0 \n\
\n\
glabel func_080291bc \n\
/* 080291bc */ PUSH {R4, LR} \n\
/* 080291be */ LDR R0, =0x030055d0 @ !PossiblePointer \n\
/* 080291c0 */ LDR R1, [R0] \n\
...
/* 080291d4 */ STRH R0, [R3] \n\
/* 080291d6 */ LDR R2, =0x000003fe @ !PossiblePointer \n\
...
/* 080291e2 */ LDR R0, =0x0000ff70 @ !PossiblePointer \n\
/* 080291e4 */ STRH R0, [R2] \n\
/* 080291e6 */ LDR R2, =0x00000402 @ !PossiblePointer \n\
