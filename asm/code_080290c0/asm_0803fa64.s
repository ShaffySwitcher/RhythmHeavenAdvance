...
.balign 4, 0 \n\
\n\
glabel func_0803fa64 \n\
/* 0803fa64 */ PUSH {R4, R5, LR} \n\
/* 0803fa66 */ SUB SP, 0xC \n\
/* 0803fa68 */ ADDS R4, R0, 0x0 @ Set R4 to R0 + 0x0 \n\
/* 0803fa6a */ ADDS R2, R1, 0x0 @ Set R2 to R1 + 0x0 \n\
/* 0803fa6c */ LDR R1, =0x030055d0 @ !PossiblePointer \n\
/* 0803fa6e */ LDR R0, [R1] \n\
/* 0803fa70 */ LDR R3, =0x0000035d @ !PossiblePointer \n\
...
/* 0803fa98 */ MOVS R2, 0x0 @ Set R2 to 0x0 \n\
 \n\
branch_0803fa9a: \n\
/* 0803fa9a */ LDR R1, =0x089e89a0 @ !PossiblePointer \n\
...
/* 0803fab2 */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 0803fab4 */ LDR R0, [R0] \n\
/* 0803fab6 */ LDR R1, =0x030055d0 @ !PossiblePointer \n\
/* 0803fab8 */ LDR R1, [R1] \n\
...
/* 0803fac8 */ LDR R3, =0x089e89ac @ !PossiblePointer \n\
