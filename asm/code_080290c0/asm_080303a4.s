...
/* 080303ba */ LDR R4, =0x03005380 @ !PossiblePointer \n\
/* 080303bc */ LDR R0, [R4] \n\
...
/* 080303da */ STRH R0, [R7] \n\
/* 080303dc */ LDR R0, =0x030055d0 @ !PossiblePointer \n\
/* 080303de */ LDR R0, [R0] \n\
...
/* 08030408 */ STR R0, [SP, 0x14] \n\
 \n\
branch_0803040a: \n\
/* 0803040a */ LDR R1, =0x03005380 @ !PossiblePointer \n\
/* 0803040c */ LDR R0, [R1] \n\
...
/* 08030428 */ LDR R2, =0x03005380 @ !PossiblePointer \n\
/* 0803042a */ LDR R0, [R2] \n\
...
/* 0803045a */ LDR R3, =0x03005380 @ !PossiblePointer \n\
/* 0803045c */ LDR R0, [R3] \n\
...
/* 08030484 */ LDR R3, =0x03005380 @ !PossiblePointer \n\
/* 08030486 */ LDR R0, [R3] \n\
...
/* 080304b8 */ LDR R2, =0x03005380 @ !PossiblePointer \n\
/* 080304ba */ LDR R0, [R2] \n\
...
/* 080304dc */ LDR R2, =0x03005380 @ !PossiblePointer \n\
/* 080304de */ LDR R0, [R2] \n\
