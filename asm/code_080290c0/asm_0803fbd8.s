...
.balign 4, 0 \n\
\n\
glabel func_0803fbd8 \n\
/* 0803fbd8 */ PUSH {R4-R6, LR} \n\
/* 0803fbda */ SUB SP, 0xC \n\
/* 0803fbdc */ MOVS R5, 0x0 @ Set R5 to 0x0 \n\
 \n\
branch_0803fbde: \n\
/* 0803fbde */ LDR R0, =0x030055d0 @ !PossiblePointer \n\
/* 0803fbe0 */ LDR R1, [R0] \n\
/* 0803fbe2 */ LDR R2, =0x0000035a @ !PossiblePointer \n\
...
/* 0803fbee */ LDR R3, =0x0000035d @ !PossiblePointer \n\
...
/* 0803fc16 */ MOVS R2, 0x0 @ Set R2 to 0x0 \n\
 \n\
branch_0803fc18: \n\
/* 0803fc18 */ LDR R1, =0x089e89b8 @ !PossiblePointer \n\
...
/* 0803fc30 */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 0803fc32 */ LDR R0, [R0] \n\
/* 0803fc34 */ LDR R1, =0x030055d0 @ !PossiblePointer \n\
/* 0803fc36 */ LDR R1, [R1] \n\
...
/* 0803fc46 */ LDR R3, =0x089e89c4 @ !PossiblePointer \n\
