...
/* 0803b266 */ LDR R0, =0x030055d0 @ !PossiblePointer \n\
...
/* 0803b27c */ LDR R0, =0xfffff800 @ !PossiblePointer \n\
...
/* 0803b28c */ LDR R4, =0x03005380 @ !PossiblePointer \n\
/* 0803b28e */ LDR R0, [R4] \n\
/* 0803b290 */ MOVS R2, 0x0 @ Set R2 to 0x0 \n\
/* 0803b292 */ LDRSH R1, [R7, R2] \n\
/* 0803b294 */ LDR R2, =0x088fdfec @ !PossiblePointer \n\
...
/* 0803b2b0 */ LDR R3, =0x0803aef5 @ !PossiblePointer \n\
...
/* 0803b2d0 */ LDR R2, =0x088fe05c @ !PossiblePointer \n\
