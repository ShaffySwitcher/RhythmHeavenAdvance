...
/* 080290c6 */ LDR R5, =0x030055d0 @ !PossiblePointer \n\
/* 080290c8 */ LDR R0, [R5] \n\
/* 080290ca */ LDR R1, =0x000003cd @ !PossiblePointer \n\
/* 080290cc */ ADDS R0, R0, R1 @ Set R0 to R0 + R1 \n\
/* 080290ce */ LDRB R4, [R0] \n\
/* 080290d0 */ LDR R0, =0x08a9b85c @ !PossiblePointer \n\
/* 080290d2 */ BL func_08002634 \n\
/* 080290d6 */ LDR R0, [R5] \n\
/* 080290d8 */ LDR R2, =0x000003ce @ !PossiblePointer \n\
...
/* 080290f2 */ LDR R2, =0x0000057c @ !PossiblePointer \n\
...
/* 08029100 */ LDR R0, =0x089e2b04 @ !PossiblePointer \n\
...
.ltorg \n\
 \n\
branch_08029120: \n\
/* 08029120 */ LDR R0, =0x030055d0 @ !PossiblePointer \n\
/* 08029122 */ LDR R0, [R0] \n\
/* 08029124 */ LDR R1, [PC, 0x44] @ 0x0802916c \n\
/* 08029126 */ ADDS R0, R0, R1 @ Set R0 to R0 + R1 \n\
/* 08029128 */ MOVS R1, 0x0 @ Set R1 to 0x0 \n\
/* 0802912a */ STRB R1, [R0] \n\
/* 0802912c */ LDR R1, [PC, 0x40] @ 0x08029170 \n\
...
/* 0802913e */ LDR R0, [PC, 0x34] @ 0x08029174 \n\
/* 08029140 */ BL func_0801d968 \n\
 \n\
branch_08029144: \n\
/* 08029144 */ LDR R0, =0x030055d0 @ !PossiblePointer \n\
/* 08029146 */ LDR R1, [R0] \n\
/* 08029148 */ LDRB R0, [R1] \n\
