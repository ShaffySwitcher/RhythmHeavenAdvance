...
.balign 4, 0 \n\
\n\
glabel func_080335e8 \n\
/* 080335e8 */ PUSH {R4, R5, LR} \n\
/* 080335ea */ SUB SP, 0xC \n\
/* 080335ec */ LDR R5, =0x03005380 @ !PossiblePointer \n\
/* 080335ee */ LDR R0, [R5] \n\
/* 080335f0 */ LDR R4, =0x030055d0 @ !PossiblePointer \n\
/* 080335f2 */ LDR R1, [R4] \n\
...
/* 0803360a */ LDR R3, =0xffe80000 @ !PossiblePointer \n\
...
/* 0803361c */ LDR R2, =0x088eef28 @ !PossiblePointer \n\
