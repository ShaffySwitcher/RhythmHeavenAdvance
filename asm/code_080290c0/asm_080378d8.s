...
.ltorg \n\
 \n\
branch_080378f0: \n\
/* 080378f0 */ LDR R0, =0x030055d0 @ !PossiblePointer \n\
/* 080378f2 */ LDR R0, [R0] \n\
...
/* 08037918 */ B branch_08037a54 \n\
 \n\
branch_0803791a: \n\
/* 0803791a */ LDR R4, =0x03005380 @ !PossiblePointer \n\
/* 0803791c */ LDR R0, [R4] \n\
...
/* 0803796a */ B branch_08037a5a \n\
 \n\
branch_0803796c: \n\
/* 0803796c */ LDR R4, =0x03005380 @ !PossiblePointer \n\
/* 0803796e */ LDR R0, [R4] \n\
/* 08037970 */ LDR R5, =0x030055d0 @ !PossiblePointer \n\
/* 08037972 */ LDR R1, [R5] \n\
...
/* 0803798c */ LDR R0, [R4] \n\
/* 0803798e */ LDR R1, =0x088f84f8 @ !PossiblePointer \n\
/* 08037990 */ MOVS R2, 0x98 @ Set R2 to 0x98 \n\
/* 08037992 */ STR R2, [SP] \n\
/* 08037994 */ LDR R2, =0x00008814 @ !PossiblePointer \n\
...
/* 080379aa */ LDR R1, =0x08a9e278 @ !PossiblePointer \n\
/* 080379ac */ B branch_08037a40 \n\
\n\
.ltorg \n\
 \n\
branch_080379c4: \n\
/* 080379c4 */ LDR R4, =0x03005380 @ !PossiblePointer \n\
/* 080379c6 */ LDR R0, [R4] \n\
/* 080379c8 */ LDR R5, =0x030055d0 @ !PossiblePointer \n\
/* 080379ca */ LDR R1, [R5] \n\
...
/* 080379e4 */ LDR R0, [R4] \n\
/* 080379e6 */ LDR R1, =0x088f8560 @ !PossiblePointer \n\
/* 080379e8 */ MOVS R2, 0x98 @ Set R2 to 0x98 \n\
/* 080379ea */ STR R2, [SP] \n\
/* 080379ec */ LDR R2, =0x00008814 @ !PossiblePointer \n\
...
/* 08037a02 */ LDR R1, =0x08a9e28c @ !PossiblePointer \n\
/* 08037a04 */ B branch_08037a40 \n\
\n\
.ltorg \n\
 \n\
branch_08037a1c: \n\
/* 08037a1c */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 08037a1e */ LDR R0, [R0] \n\
/* 08037a20 */ LDR R1, =0x088f8460 @ !PossiblePointer \n\
...
/* 08037a3e */ LDR R1, =0x08a9e2a0 @ !PossiblePointer \n\
 \n\
branch_08037a40: \n\
