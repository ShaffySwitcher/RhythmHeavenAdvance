...
/* 080404d4 */ LDR R7, =0x030055d0 @ !PossiblePointer \n\
/* 080404d6 */ LDR R4, [R7] \n\
...
/* 08040500 */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 08040502 */ LDR R0, [R0] \n\
/* 08040504 */ LDR R1, [R7] \n\
...
/* 08040526 */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 08040528 */ LDR R0, [R0] \n\
/* 0804052a */ LDR R1, [R7] \n\
...
/* 08040546 */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 08040548 */ LDR R0, [R0] \n\
/* 0804054a */ LDR R1, [R7] \n\
...
/* 08040566 */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 08040568 */ LDR R0, [R0] \n\
/* 0804056a */ LDR R1, [R7] \n\
...
.ltorg \n\
 \n\
branch_08040574: \n\
/* 08040574 */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 08040576 */ LDR R0, [R0] \n\
/* 08040578 */ LDR R1, [R7] \n\
...
/* 08040588 */ LDR R7, =0x030055d0 @ !PossiblePointer \n\
/* 0804058a */ LDR R4, [R7] \n\
...
/* 080405a2 */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 080405a4 */ LDR R0, [R0] \n\
/* 080405a6 */ LDR R1, [R7] \n\
...
/* 080405c4 */ BCS branch_080405e0 \n\
 \n\
branch_080405c6: \n\
/* 080405c6 */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 080405c8 */ LDR R0, [R0] \n\
/* 080405ca */ LDR R1, [R7] \n\
...
.ltorg \n\
 \n\
branch_080405e0: \n\
/* 080405e0 */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 080405e2 */ LDR R0, [R0] \n\
/* 080405e4 */ LDR R1, [R7] \n\
...
.ltorg \n\
 \n\
branch_080405f8: \n\
/* 080405f8 */ LDR R6, =0x030055d0 @ !PossiblePointer \n\
/* 080405fa */ LDR R4, [R6] \n\
...
/* 08040658 */ BCS branch_08040678 \n\
 \n\
branch_0804065a: \n\
/* 0804065a */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 0804065c */ LDR R0, [R0] \n\
/* 0804065e */ LDR R1, [R6] \n\
...
/* 08040688 */ BCS branch_080406a4 \n\
 \n\
branch_0804068a: \n\
/* 0804068a */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 0804068c */ LDR R0, [R0] \n\
/* 0804068e */ LDR R1, [R6] \n\
...
/* 080406b4 */ BCS branch_080406d0 \n\
 \n\
branch_080406b6: \n\
/* 080406b6 */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 080406b8 */ LDR R0, [R0] \n\
/* 080406ba */ LDR R1, [R6] \n\
...
/* 080406e2 */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 080406e4 */ LDR R0, [R0] \n\
/* 080406e6 */ LDR R1, [R6] \n\
...
.ltorg \n\
 \n\
branch_080406fc: \n\
/* 080406fc */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 080406fe */ LDR R0, [R0] \n\
/* 08040700 */ LDR R1, [R6] \n\
