...
.balign 4, 0 \n\
\n\
glabel func_0802bb98 \n\
/* 0802bb98 */ PUSH {R4, LR} \n\
/* 0802bb9a */ SUB SP, 0xC \n\
/* 0802bb9c */ LDR R0, =0x030055d0 @ !PossiblePointer \n\
/* 0802bb9e */ LDR R0, [R0] \n\
...
/* 0802bbb8 */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 0802bbba */ LDR R0, [R0] \n\
/* 0802bbbc */ MOVS R2, 0x4 @ Set R2 to 0x4 \n\
/* 0802bbbe */ LDRSH R1, [R1, R2] \n\
/* 0802bbc0 */ LDR R2, =0x088c9b98 @ !PossiblePointer \n\
...
/* 0802bbd2 */ LDR R0, =0x089e37e4 @ !PossiblePointer \n\
