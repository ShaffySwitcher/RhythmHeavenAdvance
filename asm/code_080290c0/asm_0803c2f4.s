...
/* 0803c302 */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 0803c304 */ LDR R0, [R0] \n\
/* 0803c306 */ LDR R1, =0x030055d0 @ !PossiblePointer \n\
/* 0803c308 */ LDR R1, [R1] \n\
...
/* 0803c314 */ MOVS R4, 0x0 @ Set R4 to 0x0 \n\
 \n\
branch_0803c316: \n\
/* 0803c316 */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 0803c318 */ LDR R0, [R0] \n\
/* 0803c31a */ LDR R6, =0x030055d0 @ !PossiblePointer \n\
/* 0803c31c */ LDR R1, [R6] \n\
...
/* 0803c356 */ LDR R5, =0x030055d0 @ !PossiblePointer \n\
/* 0803c358 */ LDR R1, [R5] \n\
/* 0803c35a */ STRH R0, [R1, 0x28] \n\
/* 0803c35c */ LDR R4, =0x03005380 @ !PossiblePointer \n\
/* 0803c35e */ LDR R0, [R4] \n\
...
/* 0803c370 */ LDR R0, [R4] \n\
/* 0803c372 */ LDR R1, [R5] \n\
/* 0803c374 */ LDR R2, =0x000002d2 @ !PossiblePointer \n\
