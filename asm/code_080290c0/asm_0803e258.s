...
/* 0803e262 */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 0803e264 */ LDR R0, [R0] \n\
/* 0803e266 */ LDR R1, =0x030055d0 @ !PossiblePointer \n\
/* 0803e268 */ LDR R1, [R1] \n\
...
.ltorg \n\
 \n\
branch_0803e284: \n\
/* 0803e284 */ LDR R4, =0x030055d0 @ !PossiblePointer \n\
/* 0803e286 */ LDR R0, [R4] \n\
...
/* 0803e2a0 */ LDR R5, =0x03005380 @ !PossiblePointer \n\
/* 0803e2a2 */ LDR R0, [R5] \n\
/* 0803e2a4 */ LDR R1, [R4] \n\
