...
.balign 4, 0 \n\
\n\
glabel func_0803f9a0 \n\
/* 0803f9a0 */ PUSH {R4-R7, LR} \n\
/* 0803f9a2 */ SUB SP, 0xC \n\
/* 0803f9a4 */ ADDS R6, R0, 0x0 @ Set R6 to R0 + 0x0 \n\
/* 0803f9a6 */ ADDS R4, R1, 0x0 @ Set R4 to R1 + 0x0 \n\
/* 0803f9a8 */ LDR R1, =0x030055d0 @ !PossiblePointer \n\
/* 0803f9aa */ LDR R2, [R1] \n\
/* 0803f9ac */ LDR R3, =0x0000035d @ !PossiblePointer \n\
...
/* 0803f9c0 */ LDR R7, =0x00000396 @ !PossiblePointer \n\
...
/* 0803f9e6 */ LDR R1, =0x089e8994 @ !PossiblePointer \n\
/* 0803f9e8 */ B branch_0803f9fe \n\
\n\
.ltorg \n\
 \n\
branch_0803f9fc: \n\
/* 0803f9fc */ LDR R1, =0x089e8988 @ !PossiblePointer \n\
 \n\
branch_0803f9fe: \n\
...
/* 0803fa12 */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 0803fa14 */ LDR R0, [R0] \n\
/* 0803fa16 */ LDR R5, =0x030055d0 @ !PossiblePointer \n\
/* 0803fa18 */ LDR R1, [R5] \n\
...
/* 0803fa42 */ LDR R1, [R5] \n\
/* 0803fa44 */ LDR R5, =0x0000035a @ !PossiblePointer \n\
