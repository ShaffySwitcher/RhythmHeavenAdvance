...
.balign 4, 0 \n\
\n\
glabel func_08030e84 \n\
/* 08030e84 */ PUSH {R4, R5, LR} \n\
/* 08030e86 */ SUB SP, 0x4 \n\
/* 08030e88 */ LDR R0, =0x03004afc @ !PossiblePointer \n\
/* 08030e8a */ LDRH R1, [R0] \n\
...
/* 08030e94 */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 08030e96 */ LDR R0, [R0] \n\
/* 08030e98 */ LDR R1, =0x030055d0 @ !PossiblePointer \n\
/* 08030e9a */ LDR R1, [R1] \n\
...
/* 08030ea8 */ LDR R0, =0x088eb82c @ !PossiblePointer \n\
/* 08030eaa */ CMP R1, R0 @ Check R1 - R0 \n\
/* 08030eac */ BEQ branch_08030eba \n\
/* 08030eae */ LDR R0, =0x088eb804 @ !PossiblePointer \n\
/* 08030eb0 */ CMP R1, R0 @ Check R1 - R0 \n\
/* 08030eb2 */ BEQ branch_08030eba \n\
/* 08030eb4 */ LDR R0, =0x088eb854 @ !PossiblePointer \n\
/* 08030eb6 */ CMP R1, R0 @ Check R1 - R0 \n\
/* 08030eb8 */ BNE branch_08030ee0 \n\
 \n\
branch_08030eba: \n\
/* 08030eba */ LDR R5, =0x03005380 @ !PossiblePointer \n\
/* 08030ebc */ LDR R0, [R5] \n\
/* 08030ebe */ LDR R4, =0x030055d0 @ !PossiblePointer \n\
/* 08030ec0 */ LDR R1, [R4] \n\
