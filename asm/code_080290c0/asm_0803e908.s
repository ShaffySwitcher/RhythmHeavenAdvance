...
.balign 4, 0 \n\
\n\
glabel func_0803e908 \n\
/* 0803e908 */ PUSH {R4, LR} \n\
/* 0803e90a */ SUB SP, 0xC \n\
/* 0803e90c */ LDR R4, =0x030055d0 @ !PossiblePointer \n\
/* 0803e90e */ LDR R0, [R4] \n\
...
/* 0803e91e */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 0803e920 */ LDR R0, [R0] \n\
/* 0803e922 */ MOVS R2, 0x0 @ Set R2 to 0x0 \n\
/* 0803e924 */ LDRSH R1, [R1, R2] \n\
/* 0803e926 */ LDR R2, =0x08927ecc @ !PossiblePointer \n\
...
/* 0803e93e */ LDR R1, [R4] \n\
/* 0803e940 */ LDR R2, =0x0000039e @ !PossiblePointer \n\
