...
/* 08033ba8 */ LDR R1, =0x030055d0 @ !PossiblePointer \n\
/* 08033baa */ LDR R0, [R1] \n\
...
/* 08033bb4 */ LDR R7, =0x03005380 @ !PossiblePointer \n\
...
/* 08033bda */ LDR R2, =0x00000801 @ !PossiblePointer \n\
...
/* 08033bea */ BLT branch_08033bb8 \n\
 \n\
branch_08033bec: \n\
/* 08033bec */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 08033bee */ LDR R0, [R0] \n\
/* 08033bf0 */ LDR R4, =0x030055d0 @ !PossiblePointer \n\
/* 08033bf2 */ LDR R1, [R4] \n\
...
/* 08033c0c */ LDR R0, =0x0000fffe @ !PossiblePointer \n\
/* 08033c0e */ STRH R0, [R2] \n\
