...
.balign 4, 0 \n\
\n\
glabel func_08031588 \n\
/* 08031588 */ PUSH {R4-R6, LR} \n\
/* 0803158a */ LDR R0, =0x030055d0 @ !PossiblePointer \n\
/* 0803158c */ LDR R2, [R0] \n\
...
/* 080315a2 */ STRH R0, [R1] \n\
/* 080315a4 */ LDR R4, =0x03005380 @ !PossiblePointer \n\
/* 080315a6 */ LDR R0, [R4] \n\
...
/* 080315c6 */ LDR R0, =0x088eb9fc @ !PossiblePointer \n\
...
.ltorg \n\
 \n\
branch_080315e0: \n\
/* 080315e0 */ LDR R0, =0x088eba54 @ !PossiblePointer \n\
...
.ltorg \n\
 \n\
branch_080315f4: \n\
/* 080315f4 */ LDR R0, =0x088eba9c @ !PossiblePointer \n\
...
.ltorg \n\
 \n\
branch_0803160c: \n\
/* 0803160c */ LDR R0, =0x088ebaec @ !PossiblePointer \n\
...
/* 08031626 */ LDR R1, =0x08031638 @ !PossiblePointer \n\
...
/* 08031690 */ LDR R4, =0x03005380 @ !PossiblePointer \n\
/* 08031692 */ LDR R0, [R4] \n\
...
/* 080316aa */ LDR R1, =0x030055d0 @ !PossiblePointer \n\
/* 080316ac */ LDR R0, [R1] \n\
...
/* 080316b8 */ STR R5, [R0] \n\
/* 080316ba */ LDR R0, =0x03004b10 @ !PossiblePointer \n\
