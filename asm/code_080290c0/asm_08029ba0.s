...
/* 08029ba2 */ LDR R4, =0x030055d0 @ !PossiblePointer \n\
/* 08029ba4 */ LDR R0, [R4] \n\
/* 08029ba6 */ LDRB R0, [R0] \n\
...
/* 08029bc2 */ LDR R0, =0x03004afc @ !PossiblePointer \n\
...
/* 08029bf8 */ STRH R0, [R1] \n\
 \n\
branch_08029bfa: \n\
/* 08029bfa */ LDR R0, =0x030055d0 @ !PossiblePointer \n\
/* 08029bfc */ LDR R0, [R0] \n\
...
/* 08029c2e */ LDR R4, =0x030055d0 @ !PossiblePointer \n\
/* 08029c30 */ LDR R0, [R4] \n\
/* 08029c32 */ MOVS R1, 0xD5 @ Set R1 to 0xD5 \n\
/* 08029c34 */ LSLS R1, R1, 0x2 \n\
/* 08029c36 */ ADDS R0, R0, R1 @ Set R0 to R0 + R1 \n\
/* 08029c38 */ LDR R1, =0x089e2b58 @ !PossiblePointer \n\
/* 08029c3a */ BL func_080296b0 \n\
/* 08029c3e */ LDR R1, [R4] \n\
/* 08029c40 */ LDR R2, =0x000003c1 @ !PossiblePointer \n\
...
/* 08029c4e */ LDR R1, =0x089e2b78 @ !PossiblePointer \n\
...
/* 08029c78 */ BL func_080290c4 \n\
 \n\
branch_08029c7c: \n\
/* 08029c7c */ LDR R0, =0x030055d0 @ !PossiblePointer \n\
/* 08029c7e */ LDR R1, [R0] \n\
/* 08029c80 */ LDR R2, =0x0000057c @ !PossiblePointer \n\
