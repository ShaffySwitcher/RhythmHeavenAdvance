...
.balign 4, 0 \n\
\n\
glabel func_0803d914 \n\
/* 0803d914 */ PUSH {R4-R7, LR} \n\
/* 0803d916 */ SUB SP, 0xC \n\
/* 0803d918 */ MOVS R6, 0x0 @ Set R6 to 0x0 \n\
/* 0803d91a */ LDR R7, =0x030055d0 @ !PossiblePointer \n\
 \n\
branch_0803d91c: \n\
/* 0803d91c */ LDR R0, [R7] \n\
...
/* 0803d932 */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 0803d934 */ LDR R0, [R0] \n\
/* 0803d936 */ LDR R1, [R7] \n\
...
/* 0803d956 */ LDR R5, =0x030055d0 @ !PossiblePointer \n\
/* 0803d958 */ LDR R1, [R5] \n\
...
/* 0803d974 */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 0803d976 */ LDR R0, [R0] \n\
/* 0803d978 */ LDR R1, [R5] \n\
