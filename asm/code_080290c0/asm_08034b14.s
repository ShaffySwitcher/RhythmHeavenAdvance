...
.balign 4, 0 \n\
\n\
glabel func_08034b14 \n\
/* 08034b14 */ PUSH {R4-R6, LR} \n\
/* 08034b16 */ SUB SP, 0x14 \n\
/* 08034b18 */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 08034b1a */ LDR R0, [R0] \n\
/* 08034b1c */ LDR R1, =0x088f3be8 @ !PossiblePointer \n\
/* 08034b1e */ MOVS R2, 0x14 @ Set R2 to 0x14 \n\
/* 08034b20 */ STR R2, [SP] \n\
/* 08034b22 */ LDR R2, =0x00004801 @ !PossiblePointer \n\
...
/* 08034b34 */ LDR R1, =0x030055d0 @ !PossiblePointer \n\
/* 08034b36 */ LDR R1, [R1] \n\
...
/* 08034b3e */ MOVS R5, 0x0 @ Set R5 to 0x0 \n\
 \n\
branch_08034b40: \n\
/* 08034b40 */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 08034b42 */ LDR R0, [R0] \n\
...
/* 08034b74 */ MOVS R6, 0x0 @ Set R6 to 0x0 \n\
 \n\
branch_08034b76: \n\
/* 08034b76 */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 08034b78 */ LDR R0, [R0] \n\
...
/* 08034bb2 */ STRH R0, [R1] \n\
/* 08034bb4 */ LDR R0, =0x030046a8 @ !PossiblePointer \n\
/* 08034bb6 */ LDR R0, [R0] \n\
