...
/* 08044078 */ LDR R0, =0x08a9cfb8 @ !PossiblePointer \n\
/* 0804407a */ BL func_0800274c \n\
/* 0804407e */ LDR R0, =0x08a9cfcc @ !PossiblePointer \n\
/* 08044080 */ BL func_0800274c \n\
/* 08044084 */ LDR R0, =0x08a9cff4 @ !PossiblePointer \n\
/* 08044086 */ BL func_0800274c \n\
/* 0804408a */ LDR R0, =0x08a9d008 @ !PossiblePointer \n\
/* 0804408c */ BL func_0800274c \n\
/* 08044090 */ LDR R0, =0x08a9d01c @ !PossiblePointer \n\
/* 08044092 */ BL func_0800274c \n\
/* 08044096 */ LDR R0, =0x08a9d044 @ !PossiblePointer \n\
/* 08044098 */ BL func_0800274c \n\
/* 0804409c */ LDR R0, =0x08a9d058 @ !PossiblePointer \n\
/* 0804409e */ BL func_0800274c \n\
/* 080440a2 */ LDR R0, =0x08a9d06c @ !PossiblePointer \n\
/* 080440a4 */ BL func_0800274c \n\
/* 080440a8 */ LDR R0, =0x08a9d080 @ !PossiblePointer \n\
/* 080440aa */ BL func_0800274c \n\
/* 080440ae */ LDR R0, =0x08a9d094 @ !PossiblePointer \n\
/* 080440b0 */ BL func_0800274c \n\
/* 080440b4 */ LDR R0, =0x08a9d0a8 @ !PossiblePointer \n\
/* 080440b6 */ BL func_0800274c \n\
/* 080440ba */ LDR R4, =0x030055d0 @ !PossiblePointer \n\
/* 080440bc */ LDR R0, [R4] \n\
/* 080440be */ LDR R5, =0x00000382 @ !PossiblePointer \n\
...
/* 080440e2 */ STRH R0, [R2] \n\
/* 080440e4 */ LDR R2, =0x089e9904 @ !PossiblePointer \n\
...
.ltorg \n\
 \n\
branch_08044188: \n\
/* 08044188 */ LDR R0, =0x08a9cf90 @ !PossiblePointer \n\
/* 0804418a */ BL func_080447f4 \n\
/* 0804418e */ LDR R0, =0x030053c0 @ !PossiblePointer \n\
...
/* 0804419e */ LDR R0, =0x0000ffe9 @ !PossiblePointer \n\
/* 080441a0 */ STRH R0, [R1] \n\
 \n\
branch_080441a2: \n\
/* 080441a2 */ LDR R0, =0x030055d0 @ !PossiblePointer \n\
/* 080441a4 */ LDR R1, [R0] \n\
/* 080441a6 */ LDR R0, =0x00000381 @ !PossiblePointer \n\
