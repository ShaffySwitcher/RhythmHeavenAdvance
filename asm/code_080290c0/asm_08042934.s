...
/* 08042934 */ PUSH {R4, LR} \n\
/* 08042936 */ LDR R0, =0x030055d0 @ !PossiblePointer \n\
/* 08042938 */ LDR R1, [R0] \n\
/* 0804293a */ LDRB R0, [R1] \n\
/* 0804293c */ CMP R0, 0x1 @ Compare R0 and 0x1 \n\
/* 0804293e */ BNE branch_08042982 \n\
/* 08042940 */ LDR R2, =0x00000202 @ !PossiblePointer \n\
...
/* 0804294a */ MOVS R4, 0x0 @ Set R4 to 0x0 \n\
 \n\
branch_0804294c: \n\
/* 0804294c */ LDR R0, =0x030055d0 @ !PossiblePointer \n\
/* 0804294e */ LDR R1, [R0] \n\
/* 08042950 */ LSLS R3, R4, 0x1 \n\
/* 08042952 */ LDR R2, =0x00000246 @ !PossiblePointer \n\
...
/* 08042968 */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 0804296a */ LDR R0, [R0] \n\
/* 0804296c */ LDR R2, =0x0000021e @ !PossiblePointer \n\
