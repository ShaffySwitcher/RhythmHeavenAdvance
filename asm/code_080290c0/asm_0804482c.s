...
/* 0804482e */ LDR R4, =0x030055d0 @ !PossiblePointer \n\
/* 08044830 */ LDR R0, [R4] \n\
/* 08044832 */ LDR R1, =0x0000035e @ !PossiblePointer \n\
...
/* 0804483c */ B branch_08044944 \n\
 \n\
branch_0804483e: \n\
/* 0804483e */ LDR R0, =0x08044731 @ !PossiblePointer \n\
...
/* 08044860 */ LDR R5, =0x030055d0 @ !PossiblePointer \n\
/* 08044862 */ LDR R0, [R5] \n\
/* 08044864 */ LDR R2, =0x00000362 @ !PossiblePointer \n\
...
/* 08044872 */ LDR R0, =0x03004afc @ !PossiblePointer \n\
/* 08044874 */ LDRH R1, [R0] \n\
...
/* 0804489c */ LDR R4, =0x03004afc @ !PossiblePointer \n\
/* 0804489e */ LDRH R1, [R4] \n\
...
/* 080448f8 */ LDR R0, =0x03004afc @ !PossiblePointer \n\
/* 080448fa */ LDRH R1, [R0] \n\
...
/* 0804490c */ LDR R2, =0x030055d0 @ !PossiblePointer \n\
/* 0804490e */ LDR R0, [R2] \n\
/* 08044910 */ LDR R1, =0x0000035e @ !PossiblePointer \n\
...
/* 08044928 */ BL func_080028d8 \n\
 \n\
branch_0804492c: \n\
/* 0804492c */ LDR R0, =0x08a9b85c @ !PossiblePointer \n\
/* 0804492e */ BL func_08002634 \n\
 \n\
branch_08044932: \n\
/* 08044932 */ LDR R0, =0x030055d0 @ !PossiblePointer \n\
/* 08044934 */ LDR R0, [R0] \n\
/* 08044936 */ LDR R2, =0x00000382 @ !PossiblePointer \n\
