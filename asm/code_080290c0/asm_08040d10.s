...
/* 08040d20 */ LDR R1, =0x030055d0 @ !PossiblePointer \n\
...
/* 08040d2c */ LDRB R1, [R1] \n\
/* 08040d2e */ LDR R3, =0x00000302 @ !PossiblePointer \n\
/* 08040d30 */ ADDS R2, R4, R3 @ Set R2 to R4 + R3 \n\
/* 08040d32 */ LDRH R3, [R2] \n\
/* 08040d34 */ LDR R6, =0x089e8d9c @ !PossiblePointer \n\
/* 08040d36 */ LDR R5, =0x000002ff @ !PossiblePointer \n\
...
/* 08040d42 */ LDR R2, [R2] \n\
/* 08040d44 */ STR R2, [SP] \n\
/* 08040d46 */ LDR R2, =0x03004b64 @ !PossiblePointer \n\
/* 08040d48 */ STR R2, [SP, 0x4] \n\
/* 08040d4a */ MOVS R2, 0x2 @ Set R2 to 0x2 \n\
/* 08040d4c */ BL func_08002018 \n\
/* 08040d50 */ LDR R1, =0x08040cfd @ !PossiblePointer \n\
...
/* 08040d5e */ LDRB R1, [R5] \n\
/* 08040d60 */ LDR R2, =0x000002fe @ !PossiblePointer \n\
