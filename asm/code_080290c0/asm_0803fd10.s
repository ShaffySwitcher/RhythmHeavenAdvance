...
/* 0803fd1c */ LDR R7, =0x030055d0 @ !PossiblePointer \n\
/* 0803fd1e */ LDR R1, [R7] \n\
...
/* 0803fd6e */ LDR R0, =0x00008001 @ !PossiblePointer \n\
...
/* 0803fdc2 */ LDR R1, =0x0805a910 @ !PossiblePointer \n\
...
/* 0803fdce */ LDR R4, =0x03005380 @ !PossiblePointer \n\
/* 0803fdd0 */ LDR R0, [R4] \n\
...
/* 0803fe4a */ LDR R3, =0x030055d0 @ !PossiblePointer \n\
/* 0803fe4c */ LDR R0, [R3] \n\
/* 0803fe4e */ LDRB R0, [R0] \n\
...
/* 0803fe56 */ BNE branch_0803fe68 \n\
 \n\
branch_0803fe58: \n\
/* 0803fe58 */ LDR R4, =0x0892f5a8 @ !PossiblePointer \n\
...
.ltorg \n\
 \n\
branch_0803fe68: \n\
/* 0803fe68 */ LDR R0, =0x0892cdfc @ !PossiblePointer \n\
/* 0803fe6a */ MOV R12, R0 @ Set R12 to R0 \n\
 \n\
branch_0803fe6c: \n\
/* 0803fe6c */ LDR R5, =0x030055d0 @ !PossiblePointer \n\
/* 0803fe6e */ LDR R1, [R5] \n\
...
/* 0803fe8a */ STR R0, [SP] \n\
/* 0803fe8c */ LDR R0, =0x00004003 @ !PossiblePointer \n\
...
/* 0803feca */ BNE branch_0803fee0 \n\
 \n\
branch_0803fecc: \n\
/* 0803fecc */ LDR R5, =0x0892f6c8 @ !PossiblePointer \n\
/* 0803fece */ B branch_0803fee2 \n\
\n\
.ltorg \n\
 \n\
branch_0803fee0: \n\
/* 0803fee0 */ LDR R5, =0x0892cf2c @ !PossiblePointer \n\
 \n\
branch_0803fee2: \n\
...
/* 0803fefe */ STR R0, [SP] \n\
/* 0803ff00 */ LDR R0, =0x00004002 @ !PossiblePointer \n\
...
/* 0803ff38 */ B branch_0803fdf2 \n\
 \n\
branch_0803ff3a: \n\
/* 0803ff3a */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 0803ff3c */ LDR R2, [R0] \n\
/* 0803ff3e */ LDR R0, =0x030055d0 @ !PossiblePointer \n\
/* 0803ff40 */ LDR R0, [R0] \n\
/* 0803ff42 */ LDRB R0, [R0] \n\
...
/* 0803ff4a */ BNE branch_0803ff64 \n\
 \n\
branch_0803ff4c: \n\
/* 0803ff4c */ LDR R1, =0x0892f638 @ !PossiblePointer \n\
/* 0803ff4e */ B branch_0803ff66 \n\
\n\
.ltorg \n\
 \n\
branch_0803ff64: \n\
/* 0803ff64 */ LDR R1, =0x0892ce8c @ !PossiblePointer \n\
 \n\
branch_0803ff66: \n\
/* 0803ff66 */ MOVS R0, 0x98 @ Set R0 to 0x98 \n\
/* 0803ff68 */ STR R0, [SP] \n\
/* 0803ff6a */ LDR R0, =0x00004004 @ !PossiblePointer \n\
...
/* 0803ff80 */ LDR R1, =0x030055d0 @ !PossiblePointer \n\
/* 0803ff82 */ LDR R1, [R1] \n\
/* 0803ff84 */ STRH R0, [R1, 0x2C] \n\
/* 0803ff86 */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 0803ff88 */ LDR R2, [R0] \n\
/* 0803ff8a */ LDRB R0, [R1] \n\
...
/* 0803ff92 */ BNE branch_0803ffac \n\
 \n\
branch_0803ff94: \n\
/* 0803ff94 */ LDR R1, =0x0892f638 @ !PossiblePointer \n\
/* 0803ff96 */ B branch_0803ffae \n\
\n\
.ltorg \n\
 \n\
branch_0803ffac: \n\
/* 0803ffac */ LDR R1, =0x0892ce8c @ !PossiblePointer \n\
 \n\
branch_0803ffae: \n\
/* 0803ffae */ MOVS R0, 0x98 @ Set R0 to 0x98 \n\
/* 0803ffb0 */ STR R0, [SP] \n\
/* 0803ffb2 */ LDR R0, =0x00004004 @ !PossiblePointer \n\
...
/* 0803ffc8 */ LDR R3, =0x030055d0 @ !PossiblePointer \n\
/* 0803ffca */ LDR R1, [R3] \n\
...
/* 0803ffd8 */ STRB R2, [R1] \n\
/* 0803ffda */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 0803ffdc */ LDR R2, [R0] \n\
/* 0803ffde */ LDR R0, [R3] \n\
/* 0803ffe0 */ LDRB R0, [R0] \n\
...
/* 0803ffe8 */ BNE branch_08040004 \n\
 \n\
branch_0803ffea: \n\
/* 0803ffea */ LDR R1, =0x0892f628 @ !PossiblePointer \n\
/* 0803ffec */ B branch_08040006 \n\
\n\
.ltorg \n\
 \n\
branch_08040004: \n\
/* 08040004 */ LDR R1, =0x0892ce7c @ !PossiblePointer \n\
 \n\
branch_08040006: \n\
...
/* 08040020 */ LDR R4, =0x030055d0 @ !PossiblePointer \n\
/* 08040022 */ LDR R1, [R4] \n\
/* 08040024 */ MOVS R6, 0x0 @ Set R6 to 0x0 \n\
/* 08040026 */ STRH R0, [R1, 0x3E] \n\
/* 08040028 */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 0804002a */ LDR R0, [R0] \n\
