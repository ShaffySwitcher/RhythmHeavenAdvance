...
.balign 4, 0 \n\
\n\
glabel func_0803e824 \n\
/* 0803e824 */ PUSH {R4, LR} \n\
/* 0803e826 */ SUB SP, 0x14 \n\
/* 0803e828 */ LDR R4, =0x030055d0 @ !PossiblePointer \n\
/* 0803e82a */ LDR R1, [R4] \n\
/* 0803e82c */ LDRB R3, [R1] \n\
/* 0803e82e */ CMP R3, 0x1 @ Compare R3 and 0x1 \n\
/* 0803e830 */ BNE branch_0803e86c \n\
/* 0803e832 */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 0803e834 */ LDR R0, [R0] \n\
/* 0803e836 */ LDR R1, =0x08927f2c @ !PossiblePointer \n\
...
/* 0803e872 */ LDR R0, =0x0000ffff @ !PossiblePointer \n\
 \n\
branch_0803e874: \n\
/* 0803e874 */ STRH R0, [R1] \n\
