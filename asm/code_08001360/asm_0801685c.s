...
/* 08016866 */ B branch_0801699e \n\
 \n\
branch_08016868: \n\
/* 08016868 */ LDR R0, =0x03004afc @ !PossiblePointer \n\
/* 0801686a */ LDRH R1, [R0] \n\
...
/* 0801687a */ LDR R5, =0x03005380 @ !PossiblePointer \n\
/* 0801687c */ LDR R0, [R5] \n\
/* 0801687e */ LDR R4, =0x030046a4 @ !PossiblePointer \n\
/* 08016880 */ LDR R1, [R4] \n\
...
/* 080168c6 */ LDR R5, =0x030046a4 @ !PossiblePointer \n\
/* 080168c8 */ LDR R1, [R5] \n\
...
.ltorg \n\
 \n\
branch_080168fc: \n\
/* 080168fc */ LDR R4, =0x03005380 @ !PossiblePointer \n\
/* 080168fe */ LDR R0, [R4] \n\
...
/* 0801692c */ STRB R0, [R1] \n\
 \n\
branch_0801692e: \n\
/* 0801692e */ LDR R0, =0x03004afc @ !PossiblePointer \n\
/* 08016930 */ LDRH R1, [R0] \n\
...
/* 0801693a */ LDR R4, =0x030046a4 @ !PossiblePointer \n\
/* 0801693c */ LDR R1, [R4] \n\
...
/* 08016950 */ LDR R0, [PC, 0x50] @ 0x080169a4 \n\
/* 08016952 */ LDR R0, [R0] \n\
/* 08016954 */ LDR R1, [R4] \n\
...
/* 08016962 */ BL func_08002634 \n\
 \n\
branch_08016966: \n\
/* 08016966 */ LDR R0, [PC, 0x44] @ 0x080169ac \n\
/* 08016968 */ LDRH R1, [R0] \n\
...
/* 08016972 */ LDR R4, [PC, 0x3C] @ 0x080169b0 \n\
/* 08016974 */ LDR R1, [R4] \n\
...
/* 08016988 */ LDR R0, [PC, 0x18] @ 0x080169a4 \n\
/* 0801698a */ LDR R0, [R0] \n\
/* 0801698c */ LDR R1, [R4] \n\
...
/* 08016998 */ LDR R0, [PC, 0x18] @ 0x080169b4 \n\
