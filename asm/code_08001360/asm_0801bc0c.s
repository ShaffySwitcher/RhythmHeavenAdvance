...
/* 0801bc12 */ LDR R5, =0x030046a4 @ !PossiblePointer \n\
/* 0801bc14 */ LDR R0, [R5] \n\
...
/* 0801bc3a */ LDR R0, =0x030046a8 @ !PossiblePointer \n\
/* 0801bc3c */ LDR R0, [R0] \n\
...
/* 0801bc58 */ SUBS R7, 0x1 @ Subtract 0x1 from R7 \n\
 \n\
branch_0801bc5a: \n\
/* 0801bc5a */ LDR R0, =0x030046a4 @ !PossiblePointer \n\
/* 0801bc5c */ LDR R0, [R0] \n\
...
/* 0801bc78 */ LDR R4, =0x030046a4 @ !PossiblePointer \n\
/* 0801bc7a */ LDR R0, [R4] \n\
...
.ltorg \n\
 \n\
branch_0801bcc8: \n\
/* 0801bcc8 */ LDR R0, =0x030046a4 @ !PossiblePointer \n\
/* 0801bcca */ LDR R0, [R0] \n\
