...
/* 080014a2 */ LDR R1, =0x03004afc @ !PossiblePointer \n\
/* 080014a4 */ LDR R2, =0x03004ac0 @ !PossiblePointer \n\
/* 080014a6 */ LDRH R3, [R2] \n\
...
/* 080014b0 */ STRH R4, [R1] \n\
/* 080014b2 */ LDR R1, =0x03004b00 @ !PossiblePointer \n\
...
/* 080014c2 */ LDR R0, =0x030053b8 @ !PossiblePointer \n\
/* 080014c4 */ STRH R4, [R0] \n\
/* 080014c6 */ LDR R1, =0x030000a2 @ !PossiblePointer \n\
...
.ltorg \n\
 \n\
branch_080014e4: \n\
/* 080014e4 */ LDR R4, =0x030053b8 @ !PossiblePointer \n\
/* 080014e6 */ STRH R3, [R4] \n\
/* 080014e8 */ LDR R0, =0x030000a0 @ !PossiblePointer \n\
/* 080014ea */ LDRH R1, [R0] \n\
/* 080014ec */ ADDS R2, R0, 0x0 @ Set R2 to R0 + 0x0 \n\
/* 080014ee */ CMP R1, R5 @ Check R1 - R5 \n\
/* 080014f0 */ BNE branch_08001518 \n\
/* 080014f2 */ LDR R1, =0x030000a2 @ !PossiblePointer \n\
/* 080014f4 */ LDRH R0, [R1] \n\
...
.ltorg \n\
 \n\
branch_08001518: \n\
/* 08001518 */ LDR R0, =0x030000a2 @ !PossiblePointer \n\
/* 0800151a */ STRH R3, [R0] \n\
 \n\
branch_0800151c: \n\
/* 0800151c */ LDRH R0, [R6] \n\
