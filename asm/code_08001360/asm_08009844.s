...
.balign 4, 0 \n\
\n\
glabel func_08009844 \n\
/* 08009844 */ PUSH {R4, LR} \n\
/* 08009846 */ SUB SP, 0x4 \n\
/* 08009848 */ LDR R0, =0x0800116c @ !PossiblePointer \n\
/* 0800984a */ LDR R1, =0x03001220 @ !PossiblePointer \n\
...
/* 0800985a */ LDR R4, =0x03001218 @ !PossiblePointer \n\
/* 0800985c */ MOVS R0, 0xA0 @ Set R0 to 0xA0 \n\
/* 0800985e */ LSLS R0, R0, 0x4 \n\
/* 08009860 */ BL func_08006580 \n\
/* 08009864 */ STR R0, [R4] \n\
/* 08009866 */ LDR R1, =0x0300121c @ !PossiblePointer \n\
