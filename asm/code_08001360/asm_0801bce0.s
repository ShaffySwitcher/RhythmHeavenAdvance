...
/* 0801bce6 */ LDR R0, =0x030046a4 @ !PossiblePointer \n\
/* 0801bce8 */ LDR R0, [R0] \n\
...
/* 0801bd02 */ LDR R0, =0x03004afc @ !PossiblePointer \n\
/* 0801bd04 */ LDRH R1, [R0] \n\
...
/* 0801bd12 */ MOVS R4, 0x4 @ Set R4 to 0x4 \n\
 \n\
branch_0801bd14: \n\
/* 0801bd14 */ LDR R0, =0x030053b8 @ !PossiblePointer \n\
/* 0801bd16 */ LDRH R1, [R0] \n\
...
/* 0801bd54 */ B branch_0801c01c \n\
 \n\
branch_0801bd56: \n\
/* 0801bd56 */ LDR R4, =0x030046a4 @ !PossiblePointer \n\
/* 0801bd58 */ LDR R0, [R4] \n\
...
/* 0801bd72 */ LDR R1, =0x0805942c @ !PossiblePointer \n\
/* 0801bd74 */ LDR R2, =0x0801bbd5 @ !PossiblePointer \n\
/* 0801bd76 */ LDR R4, =0x08a9b820 @ !PossiblePointer \n\
/* 0801bd78 */ STR R4, [SP] \n\
...
/* 0801bdac */ LDR R0, =0x030046a8 @ !PossiblePointer \n\
/* 0801bdae */ LDR R0, [R0] \n\
...
/* 0801bdc0 */ LDR R1, =0x0805945c @ !PossiblePointer \n\
/* 0801bdc2 */ LDR R2, =0x0801bbe9 @ !PossiblePointer \n\
/* 0801bdc4 */ LDR R0, =0x08a9d83c @ !PossiblePointer \n\
/* 0801bdc6 */ STR R0, [SP] \n\
/* 0801bdc8 */ MOVS R0, 0x1 @ Set R0 to 0x1 \n\
/* 0801bdca */ MOVS R3, 0x0 @ Set R3 to 0x0 \n\
/* 0801bdcc */ BL func_0801ac38 \n\
/* 0801bdd0 */ LDR R1, =0x08a9b820 @ !PossiblePointer \n\
...
/* 0801bdf4 */ LDR R1, =0x08a9d83c @ !PossiblePointer \n\
/* 0801bdf6 */ MOVS R0, 0x2 @ Set R0 to 0x2 \n\
/* 0801bdf8 */ BL func_0800267c \n\
 \n\
branch_0801bdfc: \n\
/* 0801bdfc */ LDR R4, =0x030046a4 @ !PossiblePointer \n\
/* 0801bdfe */ LDR R0, [R4] \n\
...
/* 0801be1e */ LDR R1, =0x08a9b820 @ !PossiblePointer \n\
...
.ltorg \n\
 \n\
branch_0801be60: \n\
/* 0801be60 */ LDR R1, =0x08a9b820 @ !PossiblePointer \n\
/* 0801be62 */ MOVS R0, 0x2 @ Set R0 to 0x2 \n\
/* 0801be64 */ BL func_0800267c \n\
/* 0801be68 */ LDR R1, =0x080594a0 @ !PossiblePointer \n\
/* 0801be6a */ LDR R2, =0x0801bc0d @ !PossiblePointer \n\
/* 0801be6c */ LDR R0, =0x08a9d774 @ !PossiblePointer \n\
/* 0801be6e */ STR R0, [SP] \n\
...
/* 0801be74 */ BL func_0801ac38 \n\
 \n\
branch_0801be78: \n\
/* 0801be78 */ LDR R5, =0x030046a4 @ !PossiblePointer \n\
/* 0801be7a */ LDR R0, [R5] \n\
...
/* 0801be8c */ LDR R1, =0x08a9b820 @ !PossiblePointer \n\
...
/* 0801beb6 */ LDR R1, [R5] \n\
/* 0801beb8 */ LDR R3, =0x0000048e @ !PossiblePointer \n\
/* 0801beba */ ADDS R2, R1, R3 @ Set R2 to R1 + R3 \n\
/* 0801bebc */ STRH R0, [R2] \n\
/* 0801bebe */ ADDS R4, R1, R4 @ Set R4 to R1 + R4 \n\
/* 0801bec0 */ LDR R0, [R4] \n\
/* 0801bec2 */ LDR R4, =0x0000048c @ !PossiblePointer \n\
...
/* 0801bed2 */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 0801bed4 */ LDR R0, [R0] \n\
/* 0801bed6 */ LDR R1, [R5] \n\
...
/* 0801bf12 */ LDR R6, =0x030046a8 @ !PossiblePointer \n\
/* 0801bf14 */ LDR R0, [R6] \n\
...
/* 0801bf58 */ LDR R1, =0x08a9b870 @ !PossiblePointer \n\
/* 0801bf5a */ B branch_0801bf8e \n\
\n\
.ltorg \n\
 \n\
branch_0801bf84: \n\
/* 0801bf84 */ LDR R1, =0x08a9b820 @ !PossiblePointer \n\
/* 0801bf86 */ B branch_0801bf8e \n\
\n\
.ltorg \n\
 \n\
branch_0801bf8c: \n\
/* 0801bf8c */ LDR R1, =0x08a9b8ac @ !PossiblePointer \n\
 \n\
branch_0801bf8e: \n\
...
.ltorg \n\
 \n\
branch_0801bf9c: \n\
/* 0801bf9c */ LDR R1, =0x08a9b870 @ !PossiblePointer \n\
/* 0801bf9e */ MOVS R0, 0x2 @ Set R0 to 0x2 \n\
/* 0801bfa0 */ BL func_0800267c \n\
/* 0801bfa4 */ BL func_0801c7c0 \n\
/* 0801bfa8 */ LDR R4, =0x030046a4 @ !PossiblePointer \n\
/* 0801bfaa */ LDR R0, [R4] \n\
...
/* 0801bfcc */ LDR R0, =0x08a9d378 @ !PossiblePointer \n\
...
.ltorg \n\
 \n\
branch_0801bff4: \n\
/* 0801bff4 */ LDR R0, =0x030046a4 @ !PossiblePointer \n\
/* 0801bff6 */ LDR R0, [R0] \n\
...
.ltorg \n\
 \n\
branch_0801c00c: \n\
/* 0801c00c */ LDR R0, =0x030046a4 @ !PossiblePointer \n\
/* 0801c00e */ LDR R0, [R0] \n\
