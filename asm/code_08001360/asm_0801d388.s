...
/* 0801d390 */ LDR R6, =0x03005380 @ !PossiblePointer \n\
/* 0801d392 */ LDR R0, [R6] \n\
/* 0801d394 */ MOV R8, R0 @ Set R8 to R0 \n\
/* 0801d396 */ LDR R5, =0x030046a4 @ !PossiblePointer \n\
/* 0801d398 */ LDR R0, [R5] \n\
...
/* 0801d3e2 */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 0801d3e4 */ LDR R3, [R0] \n\
/* 0801d3e6 */ LDR R0, =0x030046a4 @ !PossiblePointer \n\
/* 0801d3e8 */ LDR R0, [R0] \n\
