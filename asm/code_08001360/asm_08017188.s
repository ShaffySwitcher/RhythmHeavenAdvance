...
/* 08017196 */ LDR R4, =0x030046a4 @ !PossiblePointer \n\
/* 08017198 */ LDR R0, [R4] \n\
...
/* 080171c0 */ BL func_08006694 \n\
 \n\
branch_080171c4: \n\
/* 080171c4 */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 080171c6 */ LDR R4, [R0] \n\
...
/* 08017220 */ LDR R0, =0x08017169 @ !PossiblePointer \n\
/* 08017222 */ BL func_08007344 \n\
/* 08017226 */ MOVS R0, 0x1 @ Set R0 to 0x1 \n\
/* 08017228 */ BL func_080177a4 \n\
/* 0801722c */ LDR R4, =0x030046a4 @ !PossiblePointer \n\
/* 0801722e */ LDR R2, [R4] \n\
...
/* 08017270 */ STR R0, [R2, 0x14] \n\
 \n\
branch_08017272: \n\
/* 08017272 */ LDR R1, =0x030055d0 @ !PossiblePointer \n\
/* 08017274 */ LDR R2, =0x030046a4 @ !PossiblePointer \n\
/* 08017276 */ LDR R0, [R2] \n\
...
/* 080172a2 */ LDR R0, =0x030046a4 @ !PossiblePointer \n\
...
/* 080172c8 */ LDR R4, =0x030046a4 @ !PossiblePointer \n\
...
/* 080172ea */ LDR R7, =0x030046a4 @ !PossiblePointer \n\
