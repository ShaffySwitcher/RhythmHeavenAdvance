...
/* 0801a1ce */ LDR R0, =0x089cea04 @ !PossiblePointer \n\
...
.ltorg \n\
 \n\
branch_0801a1e4: \n\
/* 0801a1e4 */ LDR R0, =0x030046a8 @ !PossiblePointer \n\
/* 0801a1e6 */ LDR R0, [R0] \n\
...
/* 0801a204 */ MOVS R1, 0x2 @ Set R1 to 0x2 \n\
 \n\
branch_0801a206: \n\
/* 0801a206 */ LDR R0, =0x030046a4 @ !PossiblePointer \n\
/* 0801a208 */ LDR R2, [R0] \n\
...
/* 0801a21e */ LDR R5, [R0] \n\
 \n\
branch_0801a220: \n\
/* 0801a220 */ LDR R0, =0x089d7b64 @ !PossiblePointer \n\
...
/* 0801a232 */ LDR R0, =0x089d7b58 @ !PossiblePointer \n\
...
/* 0801a25a */ LDR R1, =0x089de670 @ !PossiblePointer \n\
...
/* 0801a26a */ LDR R1, [R6] \n\
/* 0801a26c */ STR R0, [R1] \n\
/* 0801a26e */ LDR R1, =0x06017800 @ !PossiblePointer \n\
...
/* 0801a2a4 */ LDR R5, =0x03005380 @ !PossiblePointer \n\
/* 0801a2a6 */ LDR R0, [R5] \n\
