...
.balign 4, 0 \n\
\n\
glabel func_0801c530 \n\
/* 0801c530 */ PUSH {R4-R6, LR} \n\
/* 0801c532 */ LDR R5, =0x030046a4 @ !PossiblePointer \n\
/* 0801c534 */ LDR R0, [R5] \n\
...
/* 0801c556 */ LDR R4, =0x03001547 @ !PossiblePointer \n\
/* 0801c558 */ LDR R0, [R5] \n\
...
/* 0801c566 */ STRB R0, [R4] \n\
/* 0801c568 */ LDR R6, =0x03001548 @ !PossiblePointer \n\
/* 0801c56a */ LDR R0, [R5] \n\
...
/* 0801c578 */ STRB R0, [R6] \n\
/* 0801c57a */ LDR R6, =0x03001549 @ !PossiblePointer \n\
/* 0801c57c */ LDR R0, [R5] \n\
