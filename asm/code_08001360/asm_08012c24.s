...
/* 08012c2e */ LDR R0, =0x08050bcc @ !PossiblePointer \n\
/* 08012c30 */ B branch_08012caa \n\
\n\
.ltorg \n\
 \n\
branch_08012c38: \n\
/* 08012c38 */ LDR R1, =0x089cdf24 @ !PossiblePointer \n\
...
/* 08012c60 */ LDR R0, =0x089d81b4 @ !PossiblePointer \n\
...
.ltorg \n\
 \n\
branch_08012c74: \n\
/* 08012c74 */ LDR R0, =0x089d81b4 @ !PossiblePointer \n\
...
.ltorg \n\
 \n\
branch_08012c88: \n\
/* 08012c88 */ LDR R0, =0x089d83d0 @ !PossiblePointer \n\
...
.ltorg \n\
 \n\
branch_08012ca8: \n\
/* 08012ca8 */ LDR R0, =0x08050bd0 @ !PossiblePointer \n\
 \n\
branch_08012caa: \n\
/* 08012caa */ POP {R4} \n\
/* 08012cac */ POP {R1} \n\
