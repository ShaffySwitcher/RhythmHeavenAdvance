...
/* 0801b85e */ LDR R0, =0x030046a4 @ !PossiblePointer \n\
/* 0801b860 */ LDR R0, [R0] \n\
...
/* 0801b87a */ LDR R0, =0x03004afc @ !PossiblePointer \n\
/* 0801b87c */ LDRH R1, [R0] \n\
...
/* 0801b88a */ MOVS R4, 0x4 @ Set R4 to 0x4 \n\
 \n\
branch_0801b88c: \n\
/* 0801b88c */ LDR R0, =0x030053b8 @ !PossiblePointer \n\
/* 0801b88e */ LDRH R1, [R0] \n\
...
/* 0801b8ca */ B branch_0801b9e0 \n\
 \n\
branch_0801b8cc: \n\
/* 0801b8cc */ LDR R5, =0x030046a8 @ !PossiblePointer \n\
/* 0801b8ce */ LDR R4, [R5] \n\
/* 0801b8d0 */ LDR R0, =0x030046a4 @ !PossiblePointer \n\
/* 0801b8d2 */ LDR R0, [R0] \n\
...
/* 0801b8ec */ LDR R1, =0x08a9b8ac @ !PossiblePointer \n\
...
/* 0801b94a */ LDR R1, =0x08a9b820 @ !PossiblePointer \n\
...
.ltorg \n\
 \n\
branch_0801b974: \n\
/* 0801b974 */ LDR R1, =0x08a9b870 @ !PossiblePointer \n\
/* 0801b976 */ MOVS R0, 0x2 @ Set R0 to 0x2 \n\
/* 0801b978 */ BL func_0800267c \n\
/* 0801b97c */ LDR R4, =0x030046a4 @ !PossiblePointer \n\
/* 0801b97e */ LDR R0, [R4] \n\
...
.ltorg \n\
 \n\
branch_0801b9b8: \n\
/* 0801b9b8 */ LDR R0, =0x030046a4 @ !PossiblePointer \n\
/* 0801b9ba */ LDR R0, [R0] \n\
...
.ltorg \n\
 \n\
branch_0801b9d0: \n\
/* 0801b9d0 */ LDR R0, =0x030046a4 @ !PossiblePointer \n\
/* 0801b9d2 */ LDR R0, [R0] \n\
