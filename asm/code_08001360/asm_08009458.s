...
/* 08009466 */ LDR R3, =0x030011a0 @ !PossiblePointer \n\
/* 08009468 */ LDR R0, [R3] \n\
...
/* 08009476 */ LDR R2, =0x030011b0 @ !PossiblePointer \n\
/* 08009478 */ LDR R1, [R3] \n\
...
/* 08009482 */ STR R1, [R3] \n\
 \n\
branch_08009484: \n\
/* 08009484 */ LDR R5, =0x030011a4 @ !PossiblePointer \n\
/* 08009486 */ LDRB R0, [R5] \n\
...
/* 08009496 */ LDR R3, =0x030011a8 @ !PossiblePointer \n\
/* 08009498 */ LDR R0, [R3] \n\
/* 0800949a */ LDR R1, =0x00000aaa @ !PossiblePointer \n\
/* 0800949c */ ADDS R0, R0, R1 @ Set R0 to R0 + R1 \n\
/* 0800949e */ STR R0, [R3] \n\
/* 080094a0 */ LDR R1, =0x030011ac @ !PossiblePointer \n\
/* 080094a2 */ LDR R2, [R1] \n\
...
/* 080094da */ LDR R1, =0x030011a8 @ !PossiblePointer \n\
/* 080094dc */ LDR R0, [R1] \n\
/* 080094de */ LDR R2, =0xfffffc8b @ !PossiblePointer \n\
...
/* 080094e8 */ STR R4, [R1] \n\
 \n\
branch_080094ea: \n\
/* 080094ea */ LDR R1, =0x0400010c @ !PossiblePointer \n\
/* 080094ec */ LDR R0, =0x00c3fff0 @ !PossiblePointer \n\
/* 080094ee */ STR R0, [R1] \n\
/* 080094f0 */ POP {R4, R5} \n\
/* 080094f2 */ POP {R0} \n\
/* 080094f4 */ BX R0 \n\
