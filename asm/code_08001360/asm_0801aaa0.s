...
/* 0801aaa6 */ LDR R7, =0x030046a4 @ !PossiblePointer \n\
/* 0801aaa8 */ LDR R2, [R7] \n\
...
/* 0801aab6 */ B branch_0801ac22 \n\
 \n\
branch_0801aab8: \n\
/* 0801aab8 */ LDR R3, =0x000004a1 @ !PossiblePointer \n\
...
.ltorg \n\
 \n\
branch_0801aad8: \n\
/* 0801aad8 */ LDR R6, =0x000004a2 @ !PossiblePointer \n\
...
/* 0801aaf4 */ B branch_0801ac00 \n\
 \n\
branch_0801aaf6: \n\
/* 0801aaf6 */ LDR R0, =0x03004afc @ !PossiblePointer \n\
/* 0801aaf8 */ LDRH R1, [R0] \n\
...
/* 0801ab02 */ B branch_0801ac00 \n\
 \n\
branch_0801ab04: \n\
/* 0801ab04 */ LDR R3, =0x000004ac @ !PossiblePointer \n\
...
.ltorg \n\
 \n\
branch_0801ab14: \n\
/* 0801ab14 */ LDR R0, =0x03004afc @ !PossiblePointer \n\
/* 0801ab16 */ LDRH R1, [R0] \n\
...
/* 0801ab2e */ STRB R1, [R0] \n\
/* 0801ab30 */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 0801ab32 */ LDR R0, [R0] \n\
/* 0801ab34 */ LDR R1, [R7] \n\
...
/* 0801ab40 */ LDR R2, =0x0890c540 @ !PossiblePointer \n\
/* 0801ab42 */ STR R4, [SP] \n\
...
/* 0801ab5e */ LDR R1, =0x000004ac @ !PossiblePointer \n\
...
.ltorg \n\
 \n\
branch_0801ab8c: \n\
/* 0801ab8c */ LDR R0, =0x03004afc @ !PossiblePointer \n\
/* 0801ab8e */ LDRH R1, [R0] \n\
...
/* 0801aba6 */ STRB R3, [R0] \n\
/* 0801aba8 */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 0801abaa */ LDR R0, [R0] \n\
/* 0801abac */ LDR R1, [R7] \n\
...
/* 0801abb8 */ LDR R2, =0x0890c518 @ !PossiblePointer \n\
/* 0801abba */ STR R3, [SP] \n\
 \n\
branch_0801abbc: \n\
...
/* 0801ac08 */ LDR R0, =0x030046a4 @ !PossiblePointer \n\
/* 0801ac0a */ LDR R1, [R0] \n\
/* 0801ac0c */ LDR R3, =0x000004a4 @ !PossiblePointer \n\
