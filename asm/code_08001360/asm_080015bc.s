...
.balign 4, 0 \n\
\n\
glabel func_080015bc \n\
/* 080015bc */ PUSH {R4-R7, LR} \n\
/* 080015be */ MOV R7, R8 @ Set R7 to R8 \n\
/* 080015c0 */ PUSH {R7} \n\
/* 080015c2 */ LDR R0, =0x04000130 @ !PossiblePointer \n\
/* 080015c4 */ LDRH R0, [R0] \n\
/* 080015c6 */ LDR R1, =0x030000ac @ !PossiblePointer \n\
/* 080015c8 */ LDRH R7, [R1] \n\
/* 080015ca */ ADDS R6, R7, 0x0 @ Set R6 to R7 + 0x0 \n\
/* 080015cc */ BICS R6, R0 @ Clear bits in R0 from R6 \n\
/* 080015ce */ LDR R0, =0x030000a8 @ !PossiblePointer \n\
/* 080015d0 */ LDRB R2, [R0] \n\
...
/* 080015e8 */ LDR R1, =0x030053b4 @ !PossiblePointer \n\
/* 080015ea */ LDR R0, =0x03005374 @ !PossiblePointer \n\
/* 080015ec */ LDR R2, [R1] \n\
/* 080015ee */ LDR R5, [R0] \n\
...
/* 080015f6 */ B branch_080016f2 \n\
 \n\
branch_080015f8: \n\
/* 080015f8 */ LDR R0, =0x030000a9 @ !PossiblePointer \n\
/* 080015fa */ LDRB R0, [R0] \n\
...
/* 08001680 */ B branch_08001710 \n\
 \n\
branch_08001682: \n\
/* 08001682 */ LDR R0, =0x030000aa @ !PossiblePointer \n\
/* 08001684 */ STRB R4, [R0] \n\
 \n\
branch_08001686: \n\
...
branch_0800169c: \n\
/* 0800169c */ LDR R0, [R4] \n\
/* 0800169e */ LDR R1, =0x030000b0 @ !PossiblePointer \n\
/* 080016a0 */ LDR R1, [R1] \n\
...
/* 080016e0 */ LDR R0, =0x030000b0 @ !PossiblePointer \n\
/* 080016e2 */ LDR R1, [R0] \n\
