...
/* 0801a718 */ LDR R2, =0x03004ac0 @ !PossiblePointer \n\
/* 0801a71a */ LDRH R1, [R2] \n\
...
/* 0801a724 */ LDR R0, =0x030046a4 @ !PossiblePointer \n\
/* 0801a726 */ LDR R0, [R0] \n\
...
/* 0801a73e */ LDR R4, [PC, 0x64] @ 0x0801a7a4 \n\
/* 0801a740 */ LDR R0, [R4] \n\
...
/* 0801a766 */ LDR R4, [PC, 0x3C] @ 0x0801a7a4 \n\
/* 0801a768 */ LDR R0, [R4] \n\
...
/* 0801a780 */ MOVS R5, 0x2 @ Set R5 to 0x2 \n\
 \n\
branch_0801a782: \n\
/* 0801a782 */ LDR R0, [PC, 0x24] @ 0x0801a7a8 \n\
/* 0801a784 */ LDRH R1, [R0] \n\
...
/* 0801a7b0 */ B branch_0801a83a \n\
 \n\
branch_0801a7b2: \n\
/* 0801a7b2 */ LDR R2, =0x030046a4 @ !PossiblePointer \n\
/* 0801a7b4 */ LDR R0, [R2] \n\
...
/* 0801a7c8 */ LDR R0, =0x0000ff60 @ !PossiblePointer \n\
/* 0801a7ca */ STRH R0, [R1] \n\
...
/* 0801a7d4 */ STRH R0, [R1] \n\
/* 0801a7d6 */ LDR R0, =0x08a9dc60 @ !PossiblePointer \n\
...
.ltorg \n\
 \n\
branch_0801a7ec: \n\
/* 0801a7ec */ LDR R2, =0x030046a4 @ !PossiblePointer \n\
/* 0801a7ee */ LDR R0, [R2] \n\
...
/* 0801a80a */ LDR R0, =0x0000ff60 @ !PossiblePointer \n\
/* 0801a80c */ STRH R0, [R1] \n\
/* 0801a80e */ LDR R0, =0x08a9dc4c @ !PossiblePointer \n\
