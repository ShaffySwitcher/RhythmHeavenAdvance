...
/* 080131f4 */ LDR R0, =0x030046a8 @ !PossiblePointer \n\
/* 080131f6 */ LDR R0, [R0] \n\
...
/* 08013210 */ LDR R1, =0x0600e000 @ !PossiblePointer \n\
...
/* 08013222 */ LDR R1, =0x0600c000 @ !PossiblePointer \n\
/* 08013224 */ LDR R0, =0x01000100 @ !PossiblePointer \n\
/* 08013226 */ STR R4, [SP] \n\
...
/* 08013234 */ LDR R5, =0x089cea24 @ !PossiblePointer \n\
 \n\
branch_08013236: \n\
...
/* 0801326a */ LDR R1, =0x089ceafc @ !PossiblePointer \n\
...
/* 0801327e */ LDR R0, =0x089ce344 @ !PossiblePointer \n\
...
/* 0801328a */ LDRB R2, [R0] \n\
/* 0801328c */ LDR R0, =0x089cfaac @ !PossiblePointer \n\
...
/* 080132a4 */ LDR R0, =0x089cf90c @ !PossiblePointer \n\
...
/* 080132c4 */ LDR R1, =0x00000101 @ !PossiblePointer \n\
