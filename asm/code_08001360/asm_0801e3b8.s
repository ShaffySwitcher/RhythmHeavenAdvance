...
/* 0801e3c4 */ LDR R0, =0x030046a4 @ !PossiblePointer \n\
/* 0801e3c6 */ LDR R3, [R0] \n\
...
/* 0801e3e8 */ BLE branch_0801e3da \n\
 \n\
branch_0801e3ea: \n\
/* 0801e3ea */ LDR R0, =0x030053b8 @ !PossiblePointer \n\
/* 0801e3ec */ LDRH R1, [R0] \n\
...
/* 0801e414 */ BL func_0801e4f4 \n\
 \n\
branch_0801e418: \n\
/* 0801e418 */ LDR R0, =0x030053b8 @ !PossiblePointer \n\
/* 0801e41a */ LDRH R1, [R0] \n\
...
/* 0801e424 */ LDR R0, =0x030046a4 @ !PossiblePointer \n\
/* 0801e426 */ LDR R0, [R0] \n\
...
/* 0801e43c */ BL func_0801e4f4 \n\
 \n\
branch_0801e440: \n\
/* 0801e440 */ LDR R4, =0x030053b8 @ !PossiblePointer \n\
/* 0801e442 */ LDRH R1, [R4] \n\
...
/* 0801e44c */ LDR R0, =0x030046a4 @ !PossiblePointer \n\
/* 0801e44e */ LDR R1, [R0] \n\
...
/* 0801e468 */ LDR R0, =0x030046a4 @ !PossiblePointer \n\
/* 0801e46a */ LDR R1, [R0] \n\
...
/* 0801e476 */ BL func_0801e4f4 \n\
 \n\
branch_0801e47a: \n\
/* 0801e47a */ LDR R0, =0x03004afc @ !PossiblePointer \n\
/* 0801e47c */ LDRH R1, [R0] \n\
...
/* 0801e486 */ LDR R2, =0x089ddbe8 @ !PossiblePointer \n\
/* 0801e488 */ LDR R4, =0x030046a4 @ !PossiblePointer \n\
/* 0801e48a */ LDR R1, [R4] \n\
