...
.balign 4, 0 \n\
\n\
glabel func_0801b4f4 \n\
/* 0801b4f4 */ PUSH {R4, R5, LR} \n\
/* 0801b4f6 */ MOVS R4, 0x0 @ Set R4 to 0x0 \n\
/* 0801b4f8 */ LDR R0, =0x030046a4 @ !PossiblePointer \n\
/* 0801b4fa */ LDR R0, [R0] \n\
...
/* 0801b514 */ LDR R0, =0x03004afc @ !PossiblePointer \n\
/* 0801b516 */ LDRH R1, [R0] \n\
...
/* 0801b52e */ MOVS R4, 0x4 @ Set R4 to 0x4 \n\
 \n\
branch_0801b530: \n\
/* 0801b530 */ LDR R0, =0x030053b8 @ !PossiblePointer \n\
/* 0801b532 */ LDRH R1, [R0] \n\
...
/* 0801b56c */ B branch_0801b65c \n\
 \n\
branch_0801b56e: \n\
/* 0801b56e */ LDR R5, =0x030046a4 @ !PossiblePointer \n\
/* 0801b570 */ LDR R0, [R5] \n\
...
/* 0801b580 */ LDR R0, [R5] \n\
/* 0801b582 */ LDR R2, =0x0000048e @ !PossiblePointer \n\
...
/* 0801b592 */ LDR R1, =0x08a9b820 @ !PossiblePointer \n\
/* 0801b594 */ MOVS R0, 0x2 @ Set R0 to 0x2 \n\
/* 0801b596 */ BL func_0800267c \n\
/* 0801b59a */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 0801b59c */ LDR R0, [R0] \n\
/* 0801b59e */ LDR R1, [R5] \n\
/* 0801b5a0 */ LDR R2, =0x0000048c @ !PossiblePointer \n\
...
/* 0801b5b6 */ LDR R0, [R0] \n\
/* 0801b5b8 */ LDR R1, =0x0890c3b8 @ !PossiblePointer \n\
...
.ltorg \n\
 \n\
branch_0801b5e4: \n\
/* 0801b5e4 */ LDR R1, =0x08a9b870 @ !PossiblePointer \n\
/* 0801b5e6 */ MOVS R0, 0x2 @ Set R0 to 0x2 \n\
/* 0801b5e8 */ BL func_0800267c \n\
/* 0801b5ec */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 0801b5ee */ LDR R0, [R0] \n\
/* 0801b5f0 */ LDR R4, =0x030046a4 @ !PossiblePointer \n\
/* 0801b5f2 */ LDR R1, [R4] \n\
/* 0801b5f4 */ LDR R2, =0x0000048c @ !PossiblePointer \n\
...
/* 0801b60a */ LDR R0, [R0] \n\
/* 0801b60c */ LDR R1, =0x0890c3b8 @ !PossiblePointer \n\
...
.ltorg \n\
 \n\
branch_0801b634: \n\
/* 0801b634 */ LDR R0, =0x030046a4 @ !PossiblePointer \n\
/* 0801b636 */ LDR R0, [R0] \n\
...
.ltorg \n\
 \n\
branch_0801b64c: \n\
/* 0801b64c */ LDR R0, =0x030046a4 @ !PossiblePointer \n\
/* 0801b64e */ LDR R0, [R0] \n\
