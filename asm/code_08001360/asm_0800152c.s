...
/* 08001532 */ LDR R1, =0x03005378 @ !PossiblePointer \n\
/* 08001534 */ LDR R2, =0x030046b8 @ !PossiblePointer \n\
/* 08001536 */ LDRH R3, [R2] \n\
...
/* 08001540 */ STRH R4, [R1] \n\
/* 08001542 */ LDR R1, =0x030046b4 @ !PossiblePointer \n\
...
/* 08001552 */ LDR R0, =0x0300537c @ !PossiblePointer \n\
/* 08001554 */ STRH R4, [R0] \n\
/* 08001556 */ LDR R1, =0x030000a6 @ !PossiblePointer \n\
...
.ltorg \n\
 \n\
branch_08001574: \n\
/* 08001574 */ LDR R4, =0x0300537c @ !PossiblePointer \n\
/* 08001576 */ STRH R3, [R4] \n\
/* 08001578 */ LDR R0, =0x030000a4 @ !PossiblePointer \n\
/* 0800157a */ LDRH R1, [R0] \n\
/* 0800157c */ ADDS R2, R0, 0x0 @ Set R2 to R0 + 0x0 \n\
/* 0800157e */ CMP R1, R5 @ Check R1 - R5 \n\
/* 08001580 */ BNE branch_080015a8 \n\
/* 08001582 */ LDR R1, =0x030000a6 @ !PossiblePointer \n\
/* 08001584 */ LDRH R0, [R1] \n\
...
.ltorg \n\
 \n\
branch_080015a8: \n\
/* 080015a8 */ LDR R0, =0x030000a6 @ !PossiblePointer \n\
/* 080015aa */ STRH R3, [R0] \n\
 \n\
branch_080015ac: \n\
/* 080015ac */ LDRH R0, [R6] \n\
