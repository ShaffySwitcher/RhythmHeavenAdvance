...
.balign 4, 0 \n\
\n\
glabel func_080198f8 \n\
/* 080198f8 */ PUSH {R4, R5, LR} \n\
/* 080198fa */ SUB SP, 0x54 \n\
/* 080198fc */ LDR R0, =0x089d7980 @ !PossiblePointer \n\
/* 080198fe */ LDR R0, [R0] \n\
/* 08019900 */ ADDS R4, R0, 0x0 @ Set R4 to R0 + 0x0 \n\
/* 08019902 */ ADDS R4, 0x50 @ Add 0x50 to R4 \n\
/* 08019904 */ LDR R0, =0x030046a4 @ !PossiblePointer \n\
/* 08019906 */ LDR R0, [R0] \n\
/* 08019908 */ LDR R0, [R0, 0x4] \n\
/* 0801990a */ LDR R1, =0x08054ec4 @ !PossiblePointer \n\
...
/* 08019916 */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 08019918 */ LDR R0, [R0] \n\
...
.ltorg \n\
 \n\
branch_08019978: \n\
/* 08019978 */ LDR R0, =0x089d7ae0 @ !PossiblePointer \n\
...
.ltorg \n\
 \n\
branch_08019984: \n\
/* 08019984 */ LDR R0, =0x089d7a8c @ !PossiblePointer \n\
...
.ltorg \n\
 \n\
branch_08019990: \n\
/* 08019990 */ LDR R0, =0x089d7a38 @ !PossiblePointer \n\
/* 08019992 */ BL func_08019554 \n\
 \n\
branch_08019996: \n\
/* 08019996 */ LDR R0, =0x089d7980 @ !PossiblePointer \n\
/* 08019998 */ LDR R2, [R0] \n\
...
/* 08019a1a */ LDR R0, =0x08054eec @ !PossiblePointer \n\
...
/* 08019a30 */ LDR R0, =0x030046a4 @ !PossiblePointer \n\
/* 08019a32 */ LDR R0, [R0] \n\
...
/* 08019a42 */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 08019a44 */ LDR R0, [R0] \n\
