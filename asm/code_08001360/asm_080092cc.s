...
/* 080092cc */ PUSH {LR} \n\
/* 080092ce */ LDR R0, =0x03001110 @ !PossiblePointer \n\
...
/* 080092e2 */ LDR R1, =0x03004aec @ !PossiblePointer \n\
...
/* 080092ee */ STRH R0, [R1] \n\
 \n\
branch_080092f0: \n\
/* 080092f0 */ LDR R0, =0x0300119c @ !PossiblePointer \n\
/* 080092f2 */ MOVS R1, 0x0 @ Set R1 to 0x0 \n\
/* 080092f4 */ STRB R1, [R0] \n\
/* 080092f6 */ LDR R0, =0x0300119d @ !PossiblePointer \n\
/* 080092f8 */ STRB R1, [R0] \n\
/* 080092fa */ LDR R1, =0x030064d4 @ !PossiblePointer \n\
/* 080092fc */ LDR R0, =0x080093c1 @ !PossiblePointer \n\
/* 080092fe */ STR R0, [R1] \n\
/* 08009300 */ POP {R0} \n\
/* 08009302 */ BX R0 \n\
\n\
