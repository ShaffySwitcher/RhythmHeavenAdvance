...
/* 0801d70c */ LDR R0, =0x030053b8 @ !PossiblePointer \n\
/* 0801d70e */ LDRH R1, [R0] \n\
...
/* 0801d728 */ MOVS R4, 0x3 @ Set R4 to 0x3 \n\
 \n\
branch_0801d72a: \n\
/* 0801d72a */ LDR R0, =0x03004afc @ !PossiblePointer \n\
/* 0801d72c */ LDRH R1, [R0] \n\
...
/* 0801d760 */ B branch_0801d800 \n\
 \n\
branch_0801d762: \n\
/* 0801d762 */ LDR R6, =0x030046a4 @ !PossiblePointer \n\
/* 0801d764 */ LDR R0, [R6] \n\
...
/* 0801d7a6 */ LDR R0, =0x08a9b820 @ !PossiblePointer \n\
...
.ltorg \n\
 \n\
branch_0801d7c0: \n\
/* 0801d7c0 */ LDR R0, =0x08a9b8ac @ !PossiblePointer \n\
...
.ltorg \n\
 \n\
branch_0801d7cc: \n\
/* 0801d7cc */ LDR R0, =0x030046a4 @ !PossiblePointer \n\
/* 0801d7ce */ LDR R0, [R0] \n\
...
.ltorg \n\
 \n\
branch_0801d7dc: \n\
/* 0801d7dc */ LDR R0, =0x030046a4 @ !PossiblePointer \n\
/* 0801d7de */ LDR R0, [R0] \n\
...
.ltorg \n\
 \n\
branch_0801d7ec: \n\
/* 0801d7ec */ LDR R0, =0x08a9b870 @ !PossiblePointer \n\
/* 0801d7ee */ BL func_08002634 \n\
/* 0801d7f2 */ MOVS R0, 0x0 @ Set R0 to 0x0 \n\
/* 0801d7f4 */ BL func_0800bd04 \n\
/* 0801d7f8 */ LDR R0, =0x030046a4 @ !PossiblePointer \n\
/* 0801d7fa */ LDR R1, [R0] \n\
 \n\
branch_0801d7fc: \n\
...
/* 0801d7fe */ STR R0, [R1] \n\
 \n\
branch_0801d800: \n\
/* 0801d800 */ LDR R0, =0x030046a4 @ !PossiblePointer \n\
/* 0801d802 */ LDR R0, [R0] \n\
