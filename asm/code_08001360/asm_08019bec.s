...
/* 08019bf8 */ LDR R0, =0x089d7980 @ !PossiblePointer \n\
/* 08019bfa */ LDR R0, [R0] \n\
...
/* 08019c0c */ LDR R0, =0x030046a4 @ !PossiblePointer \n\
/* 08019c0e */ LDR R1, [R0] \n\
...
/* 08019c68 */ LDR R0, =0x030046a4 @ !PossiblePointer \n\
/* 08019c6a */ LDR R0, [R0] \n\
...
/* 08019c74 */ LDR R1, =0x08054f18 @ !PossiblePointer \n\
...
/* 08019ca8 */ LDR R1, =0x08054f30 @ !PossiblePointer \n\
/* 08019caa */ B branch_08019cc0 \n\
\n\
.ltorg \n\
 \n\
branch_08019cb0: \n\
/* 08019cb0 */ LDR R0, =0x08054f14 @ !PossiblePointer \n\
/* 08019cb2 */ LDRB R0, [R0] \n\
/* 08019cb4 */ STRB R0, [R5] \n\
...
/* 08019cbe */ LDR R1, =0x08054f24 @ !PossiblePointer \n\
 \n\
branch_08019cc0: \n\
...
/* 08019cda */ MOVS R6, 0x4 @ Set R6 to 0x4 \n\
 \n\
branch_08019cdc: \n\
/* 08019cdc */ LDR R1, =0x03005380 @ !PossiblePointer \n\
...
/* 08019d20 */ LDR R0, =0x030046a4 @ !PossiblePointer \n\
/* 08019d22 */ LDR R0, [R0] \n\
