...
/* 0801e796 */ LDR R1, =0x089de670 @ !PossiblePointer \n\
...
/* 0801e7a6 */ LDR R4, =0x030046a4 @ !PossiblePointer \n\
/* 0801e7a8 */ LDR R1, [R4] \n\
/* 0801e7aa */ STR R0, [R1] \n\
...
/* 0801e7bc */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 0801e7be */ LDR R0, [R0] \n\
/* 0801e7c0 */ LDR R2, =0x089ddfac @ !PossiblePointer \n\
/* 0801e7c2 */ LDR R3, =0x0300558c @ !PossiblePointer \n\
/* 0801e7c4 */ LDR R3, [R3] \n\
...
/* 0801e7e4 */ LDR R0, =0x089ddbcc @ !PossiblePointer \n\
