...
/* 0801fa54 */ LDR R4, =0x030055d0 @ !PossiblePointer \n\
/* 0801fa56 */ LDR R0, [R4] \n\
...
/* 0801fa88 */ LDR R0, [R6] \n\
/* 0801fa8a */ LDR R1, =0x088a0df0 @ !PossiblePointer \n\
/* 0801fa8c */ MOVS R2, 0x3A @ Set R2 to 0x3A \n\
/* 0801fa8e */ STR R2, [SP] \n\
/* 0801fa90 */ LDR R5, =0x00008792 @ !PossiblePointer \n\
...
/* 0801faac */ LDR R0, [R6] \n\
/* 0801faae */ LDR R1, =0x088a0e80 @ !PossiblePointer \n\
...
branch_0801fae0: \n\
/* 0801fae0 */ LDR R0, [R6] \n\
/* 0801fae2 */ LDR R1, =0x088a11b8 @ !PossiblePointer \n\
...
/* 0801faf6 */ BL func_0804d160 \n\
 \n\
branch_0801fafa: \n\
/* 0801fafa */ LDR R0, =0x08a9c478 @ !PossiblePointer \n\
