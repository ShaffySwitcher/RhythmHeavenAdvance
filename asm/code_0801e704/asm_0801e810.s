...
.balign 4, 0 \n\
\n\
glabel func_0801e810 \n\
/* 0801e810 */ PUSH {R4, R5, LR} \n\
/* 0801e812 */ LDR R4, =0xfffffdf0 @ !PossiblePointer \n\
/* 0801e814 */ ADD SP, R4 @ Add R4 to SP \n\
/* 0801e816 */ MOVS R4, 0x0 @ Set R4 to 0x0 \n\
/* 0801e818 */ LDR R1, =0x0000020f @ !PossiblePointer \n\
 \n\
branch_0801e81a: \n\
...
/* 0801e82e */ LDR R0, =0x030053b8 @ !PossiblePointer \n\
/* 0801e830 */ LDRH R1, [R0] \n\
...
/* 0801e848 */ NEGS R2, R2 @ Set R2 to -R2 \n\
 \n\
branch_0801e84a: \n\
/* 0801e84a */ LDR R0, =0x03004ac0 @ !PossiblePointer \n\
/* 0801e84c */ LDRH R1, [R0] \n\
...
/* 0801e86e */ LDR R0, =0x030046a4 @ !PossiblePointer \n\
/* 0801e870 */ LDR R0, [R0] \n\
...
/* 0801e876 */ BL func_0801e928 \n\
 \n\
branch_0801e87a: \n\
/* 0801e87a */ LDR R2, [PC, 0x8C] @ 0x0801e908 \n\
/* 0801e87c */ LDRH R1, [R2] \n\
...
/* 0801e888 */ LDR R0, =0x030046a4 @ !PossiblePointer \n\
/* 0801e88a */ LDR R0, [R0] \n\
...
/* 0801e8b6 */ LDR R5, =0x0000020f @ !PossiblePointer \n\
 \n\
branch_0801e8b8: \n\
...
/* 0801e8ca */ BLS branch_0801e8b8 \n\
 \n\
branch_0801e8cc: \n\
/* 0801e8cc */ LDR R0, [PC, 0x38] @ 0x0801e908 \n\
/* 0801e8ce */ LDRH R1, [R0] \n\
...
/* 0801e8de */ LDR R0, =0x030046a4 @ !PossiblePointer \n\
/* 0801e8e0 */ LDR R1, [R0] \n\
