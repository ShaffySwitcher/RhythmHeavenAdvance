...
.balign 4, 0 \n\
\n\
thumb_func_start midi_direct_player_init \n\
...
/* 0804c3d0 */ LDR R0, =midi_direct_player_enabled \n\
/* 0804c3d2 */ LDRB R0, [R0] \n\
...
/* 0804c3de */ BL midi_bus_init \n\
/* 0804c3e2 */ LDR R1, =instrument_banks \n\
/* 0804c3e4 */ LDR R0, =midi_direct_player_bank_id \n\
/* 0804c3e6 */ LDRB R0, [R0] \n\
/* 0804c3e8 */ LSLS R0, R0, 0x2 \n\
/* 0804c3ea */ ADDS R0, R0, R1 @ Set R0 to R0 + R1 \n\
/* 0804c3ec */ LDR R1, [R0] \n\
/* 0804c3ee */ ADDS R0, R6, 0x0 @ Set R0 to R6 + 0x0 \n\
/* 0804c3f0 */ BL midi_bus_set_bank \n\
/* 0804c3f4 */ LDR R0, =midi_direct_player_volume \n\
/* 0804c3f6 */ LDRB R1, [R0] \n\
/* 0804c3f8 */ ADDS R0, R6, 0x0 @ Set R0 to R6 + 0x0 \n\
/* 0804c3fa */ BL midi_bus_set_volume \n\
/* 0804c3fe */ LDR R4, =midi_direct_player_priority \n\
/* 0804c400 */ LDRB R1, [R4] \n\
/* 0804c402 */ ADDS R0, R6, 0x0 @ Set R0 to R6 + 0x0 \n\
/* 0804c404 */ BL midi_bus_set_priority \n\
/* 0804c408 */ LDRB R0, [R4] \n\
/* 0804c40a */ STR R0, [SP] \n\
...
/* 0804c438 */ LDR R4, =midi_direct_player_tempo \n\
/* 0804c43a */ LDRB R3, [R4] \n\
