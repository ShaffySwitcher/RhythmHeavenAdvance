...
/* 080289fa */ LDR R7, =0x030055d0 @ !PossiblePointer \n\
/* 080289fc */ LDR R0, [R7] \n\
...
/* 08028a58 */ LDR R1, =0x03005380 @ !PossiblePointer \n\
/* 08028a5a */ MOV R8, R1 @ Set R8 to R1 \n\
/* 08028a5c */ LDR R0, [R1] \n\
/* 08028a5e */ LDR R1, =0x088c5da0 @ !PossiblePointer \n\
/* 08028a60 */ MOVS R6, 0x64 @ Set R6 to 0x64 \n\
/* 08028a62 */ STR R6, [SP] \n\
/* 08028a64 */ LDR R2, =0x0000480c @ !PossiblePointer \n\
...
/* 08028a80 */ LDR R0, [R1] \n\
/* 08028a82 */ LDR R1, =0x088c5dc0 @ !PossiblePointer \n\
/* 08028a84 */ STR R6, [SP] \n\
/* 08028a86 */ LDR R2, =0x0000480f @ !PossiblePointer \n\
...
/* 08028aa0 */ LDR R0, [R1] \n\
/* 08028aa2 */ LDR R1, =0x088c5e78 @ !PossiblePointer \n\
/* 08028aa4 */ STR R6, [SP] \n\
/* 08028aa6 */ LDR R2, =0x00004814 @ !PossiblePointer \n\
...
/* 08028ac0 */ LDR R0, [R1] \n\
/* 08028ac2 */ LDR R1, =0x088c5de0 @ !PossiblePointer \n\
/* 08028ac4 */ STR R6, [SP] \n\
/* 08028ac6 */ LDR R2, =0x00004819 @ !PossiblePointer \n\
...
/* 08028ae0 */ LDR R0, [R1] \n\
/* 08028ae2 */ LDR R1, =0x088c64f8 @ !PossiblePointer \n\
/* 08028ae4 */ STR R6, [SP] \n\
/* 08028ae6 */ LDR R2, =0x00004808 @ !PossiblePointer \n\
...
/* 08028b02 */ LDR R0, [R1] \n\
/* 08028b04 */ LDR R1, =0x088c5f08 @ !PossiblePointer \n\
/* 08028b06 */ MOVS R2, 0x61 @ Set R2 to 0x61 \n\
/* 08028b08 */ STR R2, [SP] \n\
/* 08028b0a */ LDR R2, =0x0000480a @ !PossiblePointer \n\
...
/* 08028b24 */ LDR R0, [R1] \n\
/* 08028b26 */ LDR R1, =0x088c62f0 @ !PossiblePointer \n\
/* 08028b28 */ MOVS R2, 0x60 @ Set R2 to 0x60 \n\
/* 08028b2a */ STR R2, [SP] \n\
/* 08028b2c */ LDR R2, =0x0000480b @ !PossiblePointer \n\
...
/* 08028b46 */ LDR R0, [R1] \n\
/* 08028b48 */ LDR R1, =0x088c5e98 @ !PossiblePointer \n\
/* 08028b4a */ STR R6, [SP] \n\
/* 08028b4c */ LDR R2, =0x0000481e @ !PossiblePointer \n\
...
/* 08028b66 */ LDR R0, [R1] \n\
/* 08028b68 */ LDR R1, =0x088c5e08 @ !PossiblePointer \n\
/* 08028b6a */ STR R6, [SP] \n\
/* 08028b6c */ LDR R2, =0x000047ec @ !PossiblePointer \n\
...
/* 08028b88 */ LDR R0, [R3] \n\
/* 08028b8a */ LDR R1, =0x088c6150 @ !PossiblePointer \n\
/* 08028b8c */ STR R6, [SP] \n\
/* 08028b8e */ LDR R2, =0x000047f4 @ !PossiblePointer \n\
...
/* 08028ba8 */ LDR R0, [R1] \n\
/* 08028baa */ LDR R1, =0x088c6170 @ !PossiblePointer \n\
/* 08028bac */ STR R6, [SP] \n\
...
/* 08028bc8 */ LDR R0, [R3] \n\
/* 08028bca */ LDR R1, =0x088c6190 @ !PossiblePointer \n\
/* 08028bcc */ STR R6, [SP] \n\
/* 08028bce */ LDR R2, =0x000047ee @ !PossiblePointer \n\
...
/* 08028be8 */ LDR R0, [R1] \n\
/* 08028bea */ LDR R1, =0x088c62d0 @ !PossiblePointer \n\
/* 08028bec */ STR R6, [SP] \n\
/* 08028bee */ LDR R2, =0x000047fb @ !PossiblePointer \n\
...
/* 08028c08 */ LDR R0, [R1] \n\
/* 08028c0a */ LDR R1, =0x088c6000 @ !PossiblePointer \n\
/* 08028c0c */ MOVS R2, 0x5A @ Set R2 to 0x5A \n\
/* 08028c0e */ STR R2, [SP] \n\
/* 08028c10 */ LDR R2, =0x000047f6 @ !PossiblePointer \n\
...
/* 08028c2a */ LDR R0, [R3] \n\
/* 08028c2c */ LDR R1, =0x088c5fb0 @ !PossiblePointer \n\
/* 08028c2e */ STR R6, [SP] \n\
/* 08028c30 */ LDR R2, =0x000047e2 @ !PossiblePointer \n\
...
/* 08028c4a */ LDR R0, [R1] \n\
/* 08028c4c */ LDR R1, =0x088c5f40 @ !PossiblePointer \n\
/* 08028c4e */ STR R6, [SP] \n\
/* 08028c50 */ LDR R2, =0x000047f0 @ !PossiblePointer \n\
...
/* 08028c6a */ LDR R0, [R4] \n\
/* 08028c6c */ LDR R1, =0x088c6378 @ !PossiblePointer \n\
/* 08028c6e */ MOVS R2, 0x52 @ Set R2 to 0x52 \n\
/* 08028c70 */ STR R2, [SP] \n\
/* 08028c72 */ LDR R2, =0x000047eb @ !PossiblePointer \n\
...
/* 08028c92 */ LDR R0, =0x0000fff8 @ !PossiblePointer \n\
...
/* 08028ca8 */ LDR R4, =0x00000382 @ !PossiblePointer \n\
...
/* 08028d6a */ LDR R1, =0x0000ff70 @ !PossiblePointer \n\
/* 08028d6c */ STRH R1, [R4] \n\
...
/* 08028d7a */ LDR R0, [R2] \n\
/* 08028d7c */ LDR R1, =0x088c61f0 @ !PossiblePointer \n\
...
/* 08028d9a */ LDR R1, [R7] \n\
/* 08028d9c */ LDR R4, =0x0000040a @ !PossiblePointer \n\
/* 08028d9e */ ADDS R2, R1, R4 @ Set R2 to R1 + R4 \n\
/* 08028da0 */ STRH R0, [R2] \n\
/* 08028da2 */ LDR R0, =0x0000040c @ !PossiblePointer \n\
...
/* 08028eae */ LDR R0, [R3] \n\
/* 08028eb0 */ LDR R1, =0x088c61c0 @ !PossiblePointer \n\
...
/* 08028ed0 */ LDR R0, [R7] \n\
/* 08028ed2 */ LDR R4, =0x000003f2 @ !PossiblePointer \n\
...
branch_08028fac: \n\
/* 08028fac */ LDR R2, [R2] \n\
/* 08028fae */ LDR R0, =0x030046a8 @ !PossiblePointer \n\
/* 08028fb0 */ LDR R1, [R0] \n\
...
/* 08029002 */ LDR R0, [R5] \n\
/* 08029004 */ LDR R1, =0x000003cd @ !PossiblePointer \n\
/* 08029006 */ ADDS R0, R0, R1 @ Set R0 to R0 + R1 \n\
/* 08029008 */ STRB R6, [R0] \n\
/* 0802900a */ LDR R0, [R5] \n\
/* 0802900c */ LDR R2, =0x000003ce @ !PossiblePointer \n\
...
/* 08029054 */ STRB R0, [R1] \n\
/* 08029056 */ LDR R0, [R5] \n\
/* 08029058 */ LDR R1, =0x000003c1 @ !PossiblePointer \n\
/* 0802905a */ ADDS R0, R0, R1 @ Set R0 to R0 + R1 \n\
/* 0802905c */ STRB R6, [R0] \n\
/* 0802905e */ LDR R0, [R5] \n\
/* 08029060 */ LDR R2, =0x0000057c @ !PossiblePointer \n\
