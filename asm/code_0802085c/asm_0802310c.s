...
.balign 4, 0 \n\
\n\
glabel func_0802310c \n\
/* 0802310c */ PUSH {R4, LR} \n\
/* 0802310e */ MOVS R0, 0x0 @ Set R0 to 0x0 \n\
/* 08023110 */ BL func_080173c4 \n\
/* 08023114 */ LDR R4, =0x030055d0 @ !PossiblePointer \n\
/* 08023116 */ LDR R0, [R4] \n\
/* 08023118 */ LDR R1, =0x0000040c @ !PossiblePointer \n\
/* 0802311a */ ADDS R0, R0, R1 @ Set R0 to R0 + R1 \n\
/* 0802311c */ MOVS R1, 0x1 @ Set R1 to 0x1 \n\
/* 0802311e */ STRB R1, [R0] \n\
/* 08023120 */ BL func_0800c01c \n\
/* 08023124 */ LDR R0, =0x08a9c464 @ !PossiblePointer \n\
