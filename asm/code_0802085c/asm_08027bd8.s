...
.balign 4, 0 \n\
\n\
glabel func_08027bd8 \n\
/* 08027bd8 */ PUSH {R4-R7, LR} \n\
/* 08027bda */ MOV R7, R8 @ Set R7 to R8 \n\
/* 08027bdc */ PUSH {R7} \n\
/* 08027bde */ SUB SP, 0x4 \n\
/* 08027be0 */ LDR R4, =0x030055d0 @ !PossiblePointer \n\
/* 08027be2 */ LDR R0, [R4] \n\
...
/* 08027bf4 */ BL func_0800acf8 \n\
/* 08027bf8 */ LDR R2, =0x03005380 @ !PossiblePointer \n\
/* 08027bfa */ MOV R8, R2 @ Set R8 to R2 \n\
/* 08027bfc */ LDR R0, [R2] \n\
/* 08027bfe */ LDR R1, [R4] \n\
/* 08027c00 */ LDR R6, =0x0000042c @ !PossiblePointer \n\
...
/* 08027c28 */ LDR R0, [R4] \n\
/* 08027c2a */ LDR R3, =0x0000045c @ !PossiblePointer \n\
