...
/* 08022bc2 */ LDR R7, =0x03005380 @ !PossiblePointer \n\
/* 08022bc4 */ LDR R5, =0x088ba184 @ !PossiblePointer \n\
/* 08022bc6 */ LDR R4, =0x030055d0 @ !PossiblePointer \n\
...
/* 08022c02 */ LDR R5, =0x030055d0 @ !PossiblePointer \n\
/* 08022c04 */ LDR R1, [R5] \n\
/* 08022c06 */ STRH R0, [R1, 0x6] \n\
/* 08022c08 */ LDR R0, [R7] \n\
/* 08022c0a */ LDR R1, =0x088ba1b4 @ !PossiblePointer \n\
/* 08022c0c */ STR R4, [SP] \n\
...
/* 08022c32 */ BL func_0804d614 \n\
/* 08022c36 */ LDR R0, [R7] \n\
/* 08022c38 */ LDR R1, =0x088ba244 @ !PossiblePointer \n\
...
/* 08022c50 */ BL func_0804d160 \n\
/* 08022c54 */ LDR R1, [R5] \n\
/* 08022c56 */ STRH R0, [R1, 0x8] \n\
/* 08022c58 */ LDR R0, [R7] \n\
/* 08022c5a */ LDR R1, =0x088ba1e4 @ !PossiblePointer \n\
/* 08022c5c */ STR R4, [SP] \n\
