...
.balign 4, 0 \n\
\n\
glabel func_0802259c \n\
/* 0802259c */ LDR R0, [PC, 0x190] @ 0x08022730 \n\
/* 0802259e */ LSLS R0, R0, 0x0 \n\
/* 080225a0 */ ADD R1, PC, 0x30 \n\
/* 080225a2 */ LSRS R3, R1, 0x2 \n\
/* 080225a4 */ LDR R0, [PC, 0x18C] @ 0x08022734 \n\
/* 080225a6 */ LSLS R0, R0, 0x0 \n\
/* 080225a8 */ ADD R1, PC, 0xD0 \n\
/* 080225aa */ LSRS R3, R1, 0x2 \n\
/* 080225ac */ ADD R1, PC, 0x170 \n\
/* 080225ae */ LSRS R3, R1, 0x2 \n\
/* 080225b0 */ LDR R0, [PC, 0x194] @ 0x08022748 \n\
/* 080225b2 */ LSLS R0, R0, 0x0 \n\
/* 080225b4 */ STRH R2, [R0] \n\
/* 080225b6 */ LSLS R0, R0, 0x0 \n\
/* 080225b8 */ ADD R4, PC, 0x390 \n\
/* 080225ba */ LSRS R3, R1, 0x2 \n\
/* 080225bc */ PUSH {R4, LR} \n\
