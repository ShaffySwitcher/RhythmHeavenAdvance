...
/* 080258c8 */ PUSH {R4-R6} \n\
/* 080258ca */ SUB SP, 0x8 \n\
/* 080258cc */ LDR R4, =0x030055d0 @ !PossiblePointer \n\
/* 080258ce */ LDR R1, [R4] \n\
/* 080258d0 */ LDR R2, =0x0000179c @ !PossiblePointer \n\
/* 080258d2 */ ADDS R0, R1, R2 @ Set R0 to R1 + R2 \n\
/* 080258d4 */ LDR R3, =0x0000171c @ !PossiblePointer \n\
...
/* 080258e6 */ LDR R1, [R4] \n\
/* 080258e8 */ LDR R2, =0x0000169c @ !PossiblePointer \n\
/* 080258ea */ ADDS R0, R1, R2 @ Set R0 to R1 + R2 \n\
/* 080258ec */ LDR R3, =0x0000161c @ !PossiblePointer \n\
...
/* 080258fa */ LDR R2, [R4] \n\
/* 080258fc */ LDR R1, =0x00001414 @ !PossiblePointer \n\
...
.ltorg \n\
 \n\
branch_08025924: \n\
/* 08025924 */ LDR R1, =0x089e0698 @ !PossiblePointer \n\
/* 08025926 */ LDRB R0, [R2] \n\
/* 08025928 */ LSLS R0, R0, 0x2 \n\
/* 0802592a */ ADDS R0, R0, R1 @ Set R0 to R0 + R1 \n\
/* 0802592c */ LDR R0, [R0] \n\
/* 0802592e */ LDR R3, =0x0000179c @ !PossiblePointer \n\
...
/* 0802593c */ LDR R2, =0x089e06a4 @ !PossiblePointer \n\
/* 0802593e */ LDR R1, [R4] \n\
/* 08025940 */ LDRB R0, [R1] \n\
/* 08025942 */ LSLS R0, R0, 0x2 \n\
/* 08025944 */ ADDS R0, R0, R2 @ Set R0 to R0 + R2 \n\
/* 08025946 */ LDR R0, [R0] \n\
/* 08025948 */ LDR R2, =0x0000169c @ !PossiblePointer \n\
...
/* 08025968 */ BL func_08025848 \n\
 \n\
branch_0802596c: \n\
/* 0802596c */ LDR R3, =0x030055d0 @ !PossiblePointer \n\
/* 0802596e */ MOV R10, R3 @ Set R10 to R3 \n\
/* 08025970 */ LDR R3, [R3] \n\
/* 08025972 */ LDR R6, =0x0000171c @ !PossiblePointer \n\
/* 08025974 */ ADDS R2, R3, R6 @ Set R2 to R3 + R6 \n\
/* 08025976 */ LDR R5, =0x0000179c @ !PossiblePointer \n\
...
/* 08025986 */ LDR R3, [R0] \n\
/* 08025988 */ LDR R1, =0x0000161c @ !PossiblePointer \n\
/* 0802598a */ MOV R9, R1 @ Set R9 to R1 \n\
/* 0802598c */ ADDS R2, R3, R1 @ Set R2 to R3 + R1 \n\
/* 0802598e */ LDR R0, =0x0000169c @ !PossiblePointer \n\
...
/* 080259bc */ STR R5, [SP] \n\
/* 080259be */ LDR R3, =0x0000149c @ !PossiblePointer \n\
...
/* 080259ee */ STR R3, [SP] \n\
/* 080259f0 */ LDR R2, =0x0000141c @ !PossiblePointer \n\
