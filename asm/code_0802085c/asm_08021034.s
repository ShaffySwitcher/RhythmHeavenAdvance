...
.balign 4, 0 \n\
\n\
glabel func_08021034 \n\
/* 08021034 */ PUSH {R4, LR} \n\
/* 08021036 */ MOVS R0, 0x6 @ Set R0 to 0x6 \n\
/* 08021038 */ BL func_0800c3a4 \n\
/* 0802103c */ LDR R4, =0x030055d0 @ !PossiblePointer \n\
/* 0802103e */ LDR R1, [R4] \n\
/* 08021040 */ LDR R2, =0x00000864 @ !PossiblePointer \n\
...
/* 0802104e */ LDR R0, [R4] \n\
/* 08021050 */ LDR R1, =0x00000862 @ !PossiblePointer \n\
...
/* 08021066 */ STRH R0, [R1] \n\
/* 08021068 */ LDR R0, =0x08a9bb68 @ !PossiblePointer \n\
