...
.balign 4, 0 \n\
\n\
glabel func_08022fb8 \n\
/* 08022fb8 */ PUSH {R4-R7, LR} \n\
/* 08022fba */ MOV R7, R8 @ Set R7 to R8 \n\
/* 08022fbc */ PUSH {R7} \n\
/* 08022fbe */ LDR R4, =0x030055d0 @ !PossiblePointer \n\
/* 08022fc0 */ LDR R2, [R4] \n\
...
/* 08022fe2 */ LDRH R0, [R0] \n\
/* 08022fe4 */ BL func_0800bdf8 \n\
/* 08022fe8 */ MOVS R0, 0x0 @ Set R0 to 0x0 \n\
/* 08022fea */ BL func_0800c088 \n\
/* 08022fee */ LDR R0, [R4] \n\
...
/* 08022ffa */ LDR R7, =0x03005380 @ !PossiblePointer \n\
