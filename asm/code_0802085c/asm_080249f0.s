...
.balign 4, 0 \n\
\n\
glabel func_080249f0 \n\
/* 080249f0 */ PUSH {R4, R5, LR} \n\
/* 080249f2 */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 080249f4 */ LDR R0, [R0] \n\
/* 080249f6 */ LDR R4, =0x030055d0 @ !PossiblePointer \n\
/* 080249f8 */ LDR R1, [R4] \n\
/* 080249fa */ LDR R2, =0x00000356 @ !PossiblePointer \n\
...
/* 08024a08 */ LDR R3, [R4] \n\
/* 08024a0a */ LDR R1, =0x089e0164 @ !PossiblePointer \n\
/* 08024a0c */ ASRS R0, R0, 0x16 \n\
/* 08024a0e */ ADDS R0, R0, R1 @ Set R0 to R0 + R1 \n\
/* 08024a10 */ LDR R4, =0x03004b10 @ !PossiblePointer \n\
/* 08024a12 */ LDRH R1, [R4, 0x10] \n\
/* 08024a14 */ LDRH R2, [R0] \n\
/* 08024a16 */ ADDS R1, R1, R2 @ Set R1 to R1 + R2 \n\
/* 08024a18 */ LDR R5, =0x00000362 @ !PossiblePointer \n\
