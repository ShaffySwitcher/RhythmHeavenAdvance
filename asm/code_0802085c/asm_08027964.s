...
/* 08027970 */ LDR R4, =0x030055d0 @ !PossiblePointer \n\
/* 08027972 */ LDR R0, [R4] \n\
/* 08027974 */ LDR R1, =0x00000426 @ !PossiblePointer \n\
...
/* 08027980 */ STRB R3, [R0] \n\
/* 08027982 */ LDR R1, [R4] \n\
/* 08027984 */ LDR R2, =0x0000041c @ !PossiblePointer \n\
...
/* 08027994 */ STR R0, [R2] \n\
/* 08027996 */ LDR R0, =0x00000427 @ !PossiblePointer \n\
...
/* 080279a4 */ STRB R2, [R0] \n\
/* 080279a6 */ LDR R0, [R4] \n\
/* 080279a8 */ LDR R1, =0x00000424 @ !PossiblePointer \n\
...
/* 080279c0 */ STRH R7, [R1] \n\
/* 080279c2 */ LDR R3, =0x0000045c @ !PossiblePointer \n\
...
/* 08027a30 */ LDR R6, =0x03005380 @ !PossiblePointer \n\
/* 08027a32 */ LDR R0, [R6] \n\
/* 08027a34 */ LDR R1, =0x088c8490 @ !PossiblePointer \n\
...
/* 08027a54 */ LDR R1, [R4] \n\
/* 08027a56 */ LDR R2, =0x0000042c @ !PossiblePointer \n\
...
/* 08027a6c */ LDR R0, [R6] \n\
/* 08027a6e */ LDR R1, =0x088c6548 @ !PossiblePointer \n\
...
/* 08027a88 */ LDR R1, [R4] \n\
/* 08027a8a */ LDR R3, =0x0000045e @ !PossiblePointer \n\
/* 08027a8c */ ADDS R1, R1, R3 @ Set R1 to R1 + R3 \n\
/* 08027a8e */ STRH R0, [R1] \n\
/* 08027a90 */ LDR R0, [R6] \n\
/* 08027a92 */ LDR R1, =0x088c84b0 @ !PossiblePointer \n\
...
/* 08027ac4 */ LDR R0, [R4] \n\
/* 08027ac6 */ LDR R3, =0x00000562 @ !PossiblePointer \n\
/* 08027ac8 */ ADDS R0, R0, R3 @ Set R0 to R0 + R3 \n\
/* 08027aca */ MOVS R1, 0x0 @ Set R1 to 0x0 \n\
/* 08027acc */ STRB R1, [R0] \n\
/* 08027ace */ LDR R0, [R4] \n\
/* 08027ad0 */ LDR R2, =0x00000563 @ !PossiblePointer \n\
...
branch_08027ae0: \n\
/* 08027ae0 */ LDR R0, [R6] \n\
/* 08027ae2 */ LDR R1, =0x089e172c @ !PossiblePointer \n\
/* 08027ae4 */ LSLS R4, R5, 0x2 \n\
/* 08027ae6 */ ADDS R1, R4, R1 @ Set R1 to R4 + R1 \n\
/* 08027ae8 */ LDR R1, [R1] \n\
/* 08027aea */ LDR R2, =0x089e1748 @ !PossiblePointer \n\
...
/* 08027b06 */ LDR R2, =0x00008002 @ !PossiblePointer \n\
/* 08027b08 */ STR R2, [SP, 0x10] \n\
/* 08027b0a */ MOVS R2, 0x7F @ Set R2 to 0x7F \n\
/* 08027b0c */ BL func_0804d160 \n\
/* 08027b10 */ LDR R4, =0x030055d0 @ !PossiblePointer \n\
/* 08027b12 */ LDR R1, [R4] \n\
...
/* 08027b34 */ LDR R0, [R4] \n\
/* 08027b36 */ LDR R1, =0x00000576 @ !PossiblePointer \n\
