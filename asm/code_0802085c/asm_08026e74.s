...
/* 08026e80 */ LDR R0, =0x030055d0 @ !PossiblePointer \n\
/* 08026e82 */ LDR R4, [R0] \n\
/* 08026e84 */ MOVS R1, 0xE3 @ Set R1 to 0xE3 \n\
/* 08026e86 */ LSLS R1, R1, 0x2 \n\
/* 08026e88 */ ADDS R4, R4, R1 @ Set R4 to R4 + R1 \n\
/* 08026e8a */ LDR R6, =0x03005380 @ !PossiblePointer \n\
/* 08026e8c */ LDR R0, [R6] \n\
/* 08026e8e */ LDR R1, =0x088c8008 @ !PossiblePointer \n\
/* 08026e90 */ MOVS R2, 0x40 @ Set R2 to 0x40 \n\
/* 08026e92 */ MOV R10, R2 @ Set R10 to R2 \n\
/* 08026e94 */ STR R2, [SP] \n\
/* 08026e96 */ LDR R2, =0x0000480c @ !PossiblePointer \n\
...
/* 08026eb0 */ STRH R0, [R4] \n\
/* 08026eb2 */ LDR R0, [R6] \n\
/* 08026eb4 */ LDR R1, =0x088c7f88 @ !PossiblePointer \n\
/* 08026eb6 */ MOVS R2, 0x88 @ Set R2 to 0x88 \n\
/* 08026eb8 */ STR R2, [SP] \n\
/* 08026eba */ LDR R2, =0x0000480f @ !PossiblePointer \n\
...
/* 08026ed2 */ LDR R0, [R6] \n\
/* 08026ed4 */ LDR R1, =0x088c8028 @ !PossiblePointer \n\
/* 08026ed6 */ MOV R2, R10 @ Set R2 to R10 \n\
/* 08026ed8 */ STR R2, [SP] \n\
/* 08026eda */ LDR R2, =0x00004814 @ !PossiblePointer \n\
...
/* 08026ef2 */ LDR R0, [R6] \n\
/* 08026ef4 */ LDR R1, =0x088c8048 @ !PossiblePointer \n\
/* 08026ef6 */ MOV R2, R10 @ Set R2 to R10 \n\
/* 08026ef8 */ STR R2, [SP] \n\
/* 08026efa */ LDR R2, =0x00004819 @ !PossiblePointer \n\
...
/* 08026f12 */ LDR R0, =0x0000ffff @ !PossiblePointer \n\
/* 08026f14 */ STRH R0, [R4, 0x10] \n\
/* 08026f16 */ LDR R0, [R6] \n\
/* 08026f18 */ LDR R1, =0x088c7fa8 @ !PossiblePointer \n\
/* 08026f1a */ MOV R2, R10 @ Set R2 to R10 \n\
/* 08026f1c */ STR R2, [SP] \n\
/* 08026f1e */ LDR R2, =0x0000480a @ !PossiblePointer \n\
...
/* 08026f36 */ LDR R0, [R6] \n\
/* 08026f38 */ LDR R1, =0x088c7fd8 @ !PossiblePointer \n\
/* 08026f3a */ MOV R2, R10 @ Set R2 to R10 \n\
/* 08026f3c */ STR R2, [SP] \n\
/* 08026f3e */ LDR R2, =0x0000480b @ !PossiblePointer \n\
...
/* 08026f56 */ LDR R0, [R6] \n\
/* 08026f58 */ LDR R1, =0x088c8070 @ !PossiblePointer \n\
/* 08026f5a */ MOV R2, R10 @ Set R2 to R10 \n\
/* 08026f5c */ STR R2, [SP] \n\
/* 08026f5e */ LDR R2, =0x0000481e @ !PossiblePointer \n\
...
/* 08026f76 */ LDR R0, [R6] \n\
/* 08026f78 */ LDR R1, =0x088c80b0 @ !PossiblePointer \n\
/* 08026f7a */ MOV R2, R10 @ Set R2 to R10 \n\
/* 08026f7c */ STR R2, [SP] \n\
/* 08026f7e */ LDR R7, =0x000047ec @ !PossiblePointer \n\
...
/* 08026f96 */ LDR R0, [R6] \n\
/* 08026f98 */ LDR R1, =0x088c82f8 @ !PossiblePointer \n\
/* 08026f9a */ MOV R2, R10 @ Set R2 to R10 \n\
/* 08026f9c */ STR R2, [SP] \n\
/* 08026f9e */ LDR R2, =0x000047f4 @ !PossiblePointer \n\
...
/* 08026fb6 */ LDR R0, [R6] \n\
/* 08026fb8 */ LDR R1, =0x088c8318 @ !PossiblePointer \n\
...
/* 08026fd4 */ LDR R0, [R6] \n\
/* 08026fd6 */ LDR R1, =0x088c8338 @ !PossiblePointer \n\
/* 08026fd8 */ MOV R2, R10 @ Set R2 to R10 \n\
/* 08026fda */ STR R2, [SP] \n\
/* 08026fdc */ LDR R2, =0x000047ee @ !PossiblePointer \n\
...
/* 08026ff4 */ LDR R0, [R6] \n\
/* 08026ff6 */ LDR R1, =0x088c8358 @ !PossiblePointer \n\
/* 08026ff8 */ MOV R2, R10 @ Set R2 to R10 \n\
/* 08026ffa */ STR R2, [SP] \n\
/* 08026ffc */ LDR R2, =0x000047fb @ !PossiblePointer \n\
...
/* 08027014 */ LDR R0, [R6] \n\
/* 08027016 */ LDR R1, =0x088c81b0 @ !PossiblePointer \n\
/* 08027018 */ MOV R2, R10 @ Set R2 to R10 \n\
/* 0802701a */ STR R2, [SP] \n\
/* 0802701c */ LDR R2, =0x000047f6 @ !PossiblePointer \n\
...
/* 08027034 */ LDR R0, [R6] \n\
/* 08027036 */ LDR R1, =0x088c80f0 @ !PossiblePointer \n\
/* 08027038 */ MOV R2, R10 @ Set R2 to R10 \n\
/* 0802703a */ STR R2, [SP] \n\
/* 0802703c */ LDR R2, =0x000047e2 @ !PossiblePointer \n\
...
/* 08027054 */ LDR R0, [R6] \n\
/* 08027056 */ LDR R1, =0x088c8378 @ !PossiblePointer \n\
/* 08027058 */ MOV R2, R10 @ Set R2 to R10 \n\
/* 0802705a */ STR R2, [SP] \n\
/* 0802705c */ LDR R2, =0x000047f0 @ !PossiblePointer \n\
...
/* 08027108 */ LDR R2, =0x030055d0 @ !PossiblePointer \n\
/* 0802710a */ LDR R0, [R2] \n\
/* 0802710c */ LDR R1, =0x000003c1 @ !PossiblePointer \n\
