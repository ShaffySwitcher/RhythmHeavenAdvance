...
/* 08025602 */ B branch_0802572e \n\
 \n\
branch_08025604: \n\
/* 08025604 */ LDR R7, =0x030055d0 @ !PossiblePointer \n\
/* 08025606 */ LDR R0, [R7] \n\
/* 08025608 */ LDR R2, =0x000013fb @ !PossiblePointer \n\
...
branch_0802563a: \n\
/* 0802563a */ LDR R1, [R7] \n\
/* 0802563c */ LDR R0, =0x000013f9 @ !PossiblePointer \n\
...
branch_08025648: \n\
/* 08025648 */ LDR R1, [R7] \n\
/* 0802564a */ LDR R2, =0x000013f9 @ !PossiblePointer \n\
...
/* 0802566a */ LDR R0, [R7] \n\
/* 0802566c */ LDR R2, =0x0000159c @ !PossiblePointer \n\
/* 0802566e */ ADDS R3, R0, R2 @ Set R3 to R0 + R2 \n\
/* 08025670 */ LDR R2, =0x0000149c @ !PossiblePointer \n\
/* 08025672 */ ADDS R0, R0, R2 @ Set R0 to R0 + R2 \n\
/* 08025674 */ STR R0, [SP] \n\
/* 08025676 */ LDR R5, =0x03004d64 @ !PossiblePointer \n\
...
/* 08025698 */ LDR R0, [R7] \n\
/* 0802569a */ LDR R2, =0x0000151c @ !PossiblePointer \n\
/* 0802569c */ ADDS R3, R0, R2 @ Set R3 to R0 + R2 \n\
/* 0802569e */ LDR R2, =0x0000141c @ !PossiblePointer \n\
/* 080256a0 */ ADDS R0, R0, R2 @ Set R0 to R0 + R2 \n\
/* 080256a2 */ STR R0, [SP] \n\
/* 080256a4 */ LDR R0, =0xfffffe00 @ !PossiblePointer \n\
...
/* 080256b2 */ LDR R1, =0x08025539 @ !PossiblePointer \n\
/* 080256b4 */ MOVS R2, 0x0 @ Set R2 to 0x0 \n\
/* 080256b6 */ BL func_08005d38 \n\
 \n\
branch_080256ba: \n\
...
/* 08025706 */ LDR R4, =0x03005380 @ !PossiblePointer \n\
/* 08025708 */ LDR R0, [R4] \n\
