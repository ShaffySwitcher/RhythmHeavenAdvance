...
/* 08026b48 */ LDR R5, =0x030055d0 @ !PossiblePointer \n\
/* 08026b4a */ LDR R2, [R5] \n\
/* 08026b4c */ LDR R1, =0x000013f8 @ !PossiblePointer \n\
/* 08026b4e */ ADDS R0, R2, R1 @ Set R0 to R2 + R1 \n\
/* 08026b50 */ LDRB R0, [R0] \n\
/* 08026b52 */ CMP R0, 0x0 @ Compare R0 and 0x0 \n\
/* 08026b54 */ BNE branch_08026bae \n\
/* 08026b56 */ LDR R4, =0x03004afc @ !PossiblePointer \n\
...
/* 08026b62 */ LDR R0, =0x000013d4 @ !PossiblePointer \n\
...
/* 08026b80 */ LDR R2, [R5] \n\
/* 08026b82 */ LDR R0, =0x000013d4 @ !PossiblePointer \n\
...
branch_08026b96: \n\
/* 08026b96 */ LDR R0, [R5] \n\
/* 08026b98 */ LDR R4, =0x000013d4 @ !PossiblePointer \n\
/* 08026b9a */ ADDS R0, R0, R4 @ Set R0 to R0 + R4 \n\
/* 08026b9c */ LDR R0, [R0] \n\
/* 08026b9e */ LDR R1, =0xffffff00 @ !PossiblePointer \n\
