...
.balign 4, 0 \n\
\n\
glabel func_0802424c \n\
/* 0802424c */ PUSH {LR} \n\
/* 0802424e */ MOVS R0, 0x0 @ Set R0 to 0x0 \n\
/* 08024250 */ BL func_0800c604 \n\
/* 08024254 */ BL func_08017578 \n\
/* 08024258 */ LDR R2, =0x03004b10 @ !PossiblePointer \n\
/* 0802425a */ LDR R0, =0x00000436 @ !PossiblePointer \n\
/* 0802425c */ ADDS R3, R2, R0 @ Set R3 to R2 + R0 \n\
/* 0802425e */ MOVS R1, 0x0 @ Set R1 to 0x0 \n\
/* 08024260 */ STRH R1, [R3] \n\
/* 08024262 */ LDR R0, =0x030055d0 @ !PossiblePointer \n\
/* 08024264 */ LDR R0, [R0] \n\
/* 08024266 */ LDRB R0, [R0] \n\
...
/* 08024270 */ STRH R1, [R0] \n\
/* 08024272 */ LDR R0, =0x00007fff @ !PossiblePointer \n\
/* 08024274 */ STRH R0, [R3] \n\
 \n\
branch_08024276: \n\
/* 08024276 */ POP {R0} \n\
