...
.balign 4, 0 \n\
\n\
glabel func_08026a0c \n\
/* 08026a0c */ PUSH {LR} \n\
/* 08026a0e */ LDR R0, =0x030055d0 @ !PossiblePointer \n\
/* 08026a10 */ LDR R1, [R0] \n\
/* 08026a12 */ LDR R2, =0x0000181c @ !PossiblePointer \n\
/* 08026a14 */ ADDS R0, R1, R2 @ Set R0 to R1 + R2 \n\
/* 08026a16 */ LDRB R0, [R0] \n\
/* 08026a18 */ CMP R0, 0x0 @ Compare R0 and 0x0 \n\
/* 08026a1a */ BEQ branch_08026a3a \n\
/* 08026a1c */ LDR R0, =0x0000181e @ !PossiblePointer \n\
...
/* 08026a32 */ LDR R2, =0x000013d4 @ !PossiblePointer \n\
