...
/* 08027226 */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 08027228 */ LDR R0, [R0] \n\
...
.ltorg \n\
 \n\
branch_08027254: \n\
/* 08027254 */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 08027256 */ LDR R0, [R0] \n\
/* 08027258 */ MOVS R2, 0x12 @ Set R2 to 0x12 \n\
/* 0802725a */ LDRSH R1, [R5, R2] \n\
/* 0802725c */ LDR R2, [PC, 0x34] @ 0x08027294 \n\
...
/* 08027270 */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 08027272 */ LDR R0, [R0] \n\
...
\n\
.ltorg \n\
/* 08027294 */ STRH R0, [R7, 0x16] \n\
/* 08027296 */ LSRS R4, R1, 0x2 \n\
 \n\
branch_08027298: \n\
/* 08027298 */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 0802729a */ LDR R0, [R0] \n\
/* 0802729c */ MOVS R2, 0x1A @ Set R2 to 0x1A \n\
/* 0802729e */ LDRSH R1, [R5, R2] \n\
/* 080272a0 */ LDR R2, [PC, 0x34] @ 0x080272d8 \n\
...
/* 080272b4 */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 080272b6 */ LDR R0, [R0] \n\
...
\n\
.ltorg \n\
/* 080272d8 */ STRH R0, [R6, 0x6] \n\
/* 080272da */ LSRS R4, R1, 0x2 \n\
 \n\
branch_080272dc: \n\
/* 080272dc */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 080272de */ LDR R0, [R0] \n\
/* 080272e0 */ MOVS R2, 0x1C @ Set R2 to 0x1C \n\
/* 080272e2 */ LDRSH R1, [R5, R2] \n\
/* 080272e4 */ LDR R2, =0x088c81b0 @ !PossiblePointer \n\
