...
/* 08021a70 */ LDR R7, =0x030055d0 @ !PossiblePointer \n\
/* 08021a72 */ LDR R4, [R7] \n\
...
.ltorg \n\
 \n\
branch_08021b3c: \n\
/* 08021b3c */ LDR R0, =0x08a9e19c @ !PossiblePointer \n\
...
/* 08021b72 */ LDR R0, =0xfffffe00 @ !PossiblePointer \n\
...
/* 08021b86 */ LDRB R0, [R0] \n\
/* 08021b88 */ LDR R3, =0x088acd54 @ !PossiblePointer \n\
/* 08021b8a */ CMP R0, 0x0 @ Compare R0 and 0x0 \n\
/* 08021b8c */ BEQ branch_08021b90 \n\
/* 08021b8e */ LDR R3, =0x088acfc4 @ !PossiblePointer \n\
 \n\
branch_08021b90: \n\
...
/* 08021b9c */ LDR R4, =0x03005380 @ !PossiblePointer \n\
/* 08021b9e */ LDR R0, [R4] \n\
...
/* 08021bba */ LDR R0, [R4] \n\
/* 08021bbc */ LDR R1, =0x088accfc @ !PossiblePointer \n\
...
/* 08021be0 */ LDR R1, =0x08a9e14c @ !PossiblePointer \n\
...
/* 08021c0e */ LDR R0, =0xfffffe00 @ !PossiblePointer \n\
...
/* 08021c1e */ LDRB R0, [R0] \n\
/* 08021c20 */ LDR R3, =0x088acc94 @ !PossiblePointer \n\
/* 08021c22 */ CMP R0, 0x0 @ Compare R0 and 0x0 \n\
/* 08021c24 */ BEQ branch_08021c28 \n\
/* 08021c26 */ LDR R3, =0x088acf7c @ !PossiblePointer \n\
 \n\
branch_08021c28: \n\
...
/* 08021c34 */ LDR R4, =0x03005380 @ !PossiblePointer \n\
/* 08021c36 */ LDR R0, [R4] \n\
...
/* 08021c52 */ LDR R0, [R4] \n\
/* 08021c54 */ LDR R1, =0x088accfc @ !PossiblePointer \n\
...
/* 08021ca2 */ LDR R0, =0x08a9e1ec @ !PossiblePointer \n\
...
/* 08021cb8 */ STRH R0, [R1, 0xC] \n\
 \n\
branch_08021cba: \n\
/* 08021cba */ LDR R0, =0x030055d0 @ !PossiblePointer \n\
/* 08021cbc */ LDR R0, [R0] \n\
/* 08021cbe */ LDRB R0, [R0] \n\
...
/* 08021ccc */ LDR R3, =0x088ad0c4 @ !PossiblePointer \n\
/* 08021cce */ ADDS R1, R3, 0x0 @ Set R1 to R3 + 0x0 \n\
/* 08021cd0 */ SUBS R1, 0x20 @ Subtract 0x20 from R1 \n\
/* 08021cd2 */ STR R1, [SP] \n\
/* 08021cd4 */ LDR R1, =0x03004be4 @ !PossiblePointer \n\
...
/* 08021cf6 */ BL func_0802139c \n\
 \n\
branch_08021cfa: \n\
/* 08021cfa */ LDR R0, =0x030055d0 @ !PossiblePointer \n\
/* 08021cfc */ LDR R1, [R0] \n\
...
/* 08021d08 */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 08021d0a */ LDR R0, [R0] \n\
