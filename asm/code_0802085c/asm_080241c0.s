...
.balign 4, 0 \n\
\n\
glabel func_080241c0 \n\
/* 080241c0 */ PUSH {R4-R7, LR} \n\
/* 080241c2 */ MOV R7, R8 @ Set R7 to R8 \n\
/* 080241c4 */ PUSH {R7} \n\
/* 080241c6 */ SUB SP, 0xC \n\
/* 080241c8 */ LDR R0, =0x030055d0 @ !PossiblePointer \n\
/* 080241ca */ LDR R0, [R0] \n\
...
/* 080241d8 */ LDR R3, =0x088c418c @ !PossiblePointer \n\
/* 080241da */ CMP R0, 0x0 @ Compare R0 and 0x0 \n\
/* 080241dc */ BEQ branch_080241e0 \n\
/* 080241de */ LDR R3, =0x088c2e50 @ !PossiblePointer \n\
 \n\
branch_080241e0: \n\
/* 080241e0 */ LDR R6, =0x03005380 @ !PossiblePointer \n\
/* 080241e2 */ LDR R0, [R6] \n\
