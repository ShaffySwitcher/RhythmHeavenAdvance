...
.balign 4, 0 \n\
\n\
glabel func_08024c2c \n\
/* 08024c2c */ PUSH {R4, R5, LR} \n\
/* 08024c2e */ LDR R0, =0x030055d0 @ !PossiblePointer \n\
/* 08024c30 */ LDR R4, [R0] \n\
...
/* 08024c3c */ LDR R2, =0x00000376 @ !PossiblePointer \n\
...
/* 08024c48 */ LDR R2, =0x00000377 @ !PossiblePointer \n\
...
/* 08024c62 */ LDR R2, =0x0000037a @ !PossiblePointer \n\
...
/* 08024c6e */ LDR R2, =0x0000037b @ !PossiblePointer \n\
...
/* 08024c88 */ LDR R2, =0x00000379 @ !PossiblePointer \n\
