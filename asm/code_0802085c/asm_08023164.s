...
.balign 4, 0 \n\
\n\
glabel func_08023164 \n\
/* 08023164 */ PUSH {R4, LR} \n\
/* 08023166 */ SUB SP, 0x14 \n\
/* 08023168 */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 0802316a */ LDR R0, [R0] \n\
/* 0802316c */ LDR R1, =0x088ba5c4 @ !PossiblePointer \n\
...
/* 08023188 */ LDR R2, =0x030055d0 @ !PossiblePointer \n\
/* 0802318a */ LDR R0, [R2] \n\
/* 0802318c */ LDR R1, =0x00000414 @ !PossiblePointer \n\
/* 0802318e */ ADDS R0, R0, R1 @ Set R0 to R0 + R1 \n\
/* 08023190 */ STRB R4, [R0] \n\
/* 08023192 */ LDR R0, =0x030046a8 @ !PossiblePointer \n\
/* 08023194 */ LDR R1, [R0] \n\
/* 08023196 */ MOVS R0, 0xAA @ Set R0 to 0xAA \n\
/* 08023198 */ LSLS R0, R0, 0x2 \n\
/* 0802319a */ ADDS R1, R1, R0 @ Set R1 to R1 + R0 \n\
/* 0802319c */ LDR R0, [R2] \n\
/* 0802319e */ LDR R2, =0x00000424 @ !PossiblePointer \n\
