...
/* 08027dfc */ PUSH {R4, LR} \n\
/* 08027dfe */ LDR R4, =0x030055d0 @ !PossiblePointer \n\
/* 08027e00 */ LDR R2, [R4] \n\
/* 08027e02 */ LDR R0, =0x0000041c @ !PossiblePointer \n\
...
/* 08027e3a */ BL func_080271f0 \n\
 \n\
branch_08027e3e: \n\
/* 08027e3e */ LDR R0, =0x030055d0 @ !PossiblePointer \n\
/* 08027e40 */ LDR R0, [R0] \n\
/* 08027e42 */ LDR R2, =0x0000045a @ !PossiblePointer \n\
...
/* 08027e9e */ BL func_0800c128 \n\
 \n\
branch_08027ea2: \n\
/* 08027ea2 */ LDR R0, =0x030055d0 @ !PossiblePointer \n\
/* 08027ea4 */ LDR R1, [R0] \n\
/* 08027ea6 */ LDR R3, =0x00000427 @ !PossiblePointer \n\
/* 08027ea8 */ ADDS R0, R1, R3 @ Set R0 to R1 + R3 \n\
/* 08027eaa */ LDRB R0, [R0] \n\
/* 08027eac */ CMP R0, 0x0 @ Compare R0 and 0x0 \n\
/* 08027eae */ BEQ branch_08027ebe \n\
/* 08027eb0 */ LDR R0, =0x00000426 @ !PossiblePointer \n\
...
/* 08027ec2 */ LDR R4, =0x030055d0 @ !PossiblePointer \n\
/* 08027ec4 */ LDR R0, [R4] \n\
...
/* 08027eec */ STRB R0, [R2] \n\
/* 08027eee */ LDR R0, =0x08a9db84 @ !PossiblePointer \n\
