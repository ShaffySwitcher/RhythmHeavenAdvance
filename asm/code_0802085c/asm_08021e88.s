...
/* 08021e88 */ PUSH {R4, LR} \n\
/* 08021e8a */ SUB SP, 0xC \n\
/* 08021e8c */ LDR R3, =0x030055d0 @ !PossiblePointer \n\
/* 08021e8e */ LDR R2, [R3] \n\
...
/* 08021ea8 */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 08021eaa */ LDR R0, [R0] \n\
/* 08021eac */ MOVS R2, 0x4 @ Set R2 to 0x4 \n\
/* 08021eae */ LDRSH R1, [R4, R2] \n\
/* 08021eb0 */ LDR R2, =0x088acd54 @ !PossiblePointer \n\
...
.ltorg \n\
 \n\
branch_08021ed0: \n\
/* 08021ed0 */ LDR R0, =0x03005380 @ !PossiblePointer \n\
/* 08021ed2 */ LDR R0, [R0] \n\
/* 08021ed4 */ MOVS R2, 0x4 @ Set R2 to 0x4 \n\
/* 08021ed6 */ LDRSH R1, [R4, R2] \n\
/* 08021ed8 */ LDR R2, =0x088acc94 @ !PossiblePointer \n\
...
/* 08021ee6 */ BL func_0804d8f8 \n\
 \n\
branch_08021eea: \n\
/* 08021eea */ LDR R0, =0x08a9e084 @ !PossiblePointer \n\
