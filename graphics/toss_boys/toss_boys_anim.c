...
const struct Animation anim_toss_boys_beat_r[] = {
...
const struct Animation anim_toss_boys_beat_b[] = {
...
const struct Animation anim_toss_boys_beat_y[] = {
...
const struct Animation anim_toss_boys_pass_r[] = {
...
const struct Animation anim_toss_boys_pass_b[] = {
...
const struct Animation anim_toss_boys_pass_y[] = {
...
const struct Animation anim_toss_boys_dispenser_close[] = {
...
// [D_089240c8] Ball
const struct Animation anim_toss_boys_ball1[] = {
    /* 000 */ { toss_boys_cel067, 4 },
    /* End */ END_ANIMATION
};

// [D_089240d8] Ball (most frames are a silhouette)
const struct Animation anim_toss_boys_ball2[] = {
...
const struct Animation anim_toss_boys_ball_wobble[] = {
...
const struct Animation anim_toss_boys_miss_r[] = {
...
const struct Animation anim_toss_boys_miss_b[] = {
...
const struct Animation anim_toss_boys_miss_y[] = {
...
const struct Animation anim_toss_boys_ball3[] = {
    /* 000 */ { toss_boys_cel077, 4 },
    /* End */ END_ANIMATION
};

// [D_089241b8] Aka-chan - Toss (Crouching)
const struct Animation anim_toss_boys_super_pass_r[] = {
...
const struct Animation anim_toss_boys_super_pass_b[] = {
...
const struct Animation anim_toss_boys_super_pass_y[] = {
...
const struct Animation anim_toss_boys_pop_effect[] = {
...
const struct Animation anim_toss_boys_super_beat_r[] = {
...
const struct Animation anim_toss_boys_super_beat_b[] = {
...
const struct Animation anim_toss_boys_super_beat_y[] = {
...
const struct Animation anim_toss_boys_ball_flash[] = {
...
const struct Animation anim_toss_boys_catch_r[] = {
...
const struct Animation anim_toss_boys_catch_b[] = {
...
const struct Animation anim_toss_boys_catch_y[] = {
...
const struct Animation anim_toss_boys_ready_y[] = {
...
const struct Animation anim_toss_boys_ready_r[] = {
...
const struct Animation anim_toss_boys_ready_b[] = {
...
const struct Animation anim_toss_boys_pop_y[] = {
...
const struct Animation anim_toss_boys_pop_r[] = {
...
const struct Animation anim_toss_boys_pop_b[] = {
...
const struct Animation anim_toss_boys_text_skip_tutorial[] = {
    /* 000 */ { toss_boys_cel129, 4 },
    /* End */ END_ANIMATION
};

// [D_089244a0] Aka-chan - Barely
const struct Animation anim_toss_boys_barely_r[] = {
...
const struct Animation anim_toss_boys_barely_b[] = {
...
const struct Animation anim_toss_boys_barely_y[] = {
...
const struct Animation anim_toss_boys_arrow_r[] = {
    /* 000 */ { toss_boys_cel151, 30 },
    /* End */ END_ANIMATION
};

// [D_08924570] Start Indicator Arrow - Ao-kun
const struct Animation anim_toss_boys_arrow_b[] = {
    /* 000 */ { toss_boys_cel152, 30 },
    /* End */ END_ANIMATION
};

// [D_08924580] Start Indicator Arrow - Kii-yan
const struct Animation anim_toss_boys_arrow_y[] = {
