...
// [D_088f67d0] Up Arrow
const struct Animation anim_concert_hall_arrow_up[] = {
...
const struct Animation anim_concert_hall_arrow_down[] = {
    /* 000 */ { concert_hall_cel000, 20 },
...
const struct Animation anim_concert_hall_start_icon[] = {
    /* 000 */ { concert_hall_cel003, 4 },
    /* End */ END_ANIMATION
};

// [D_088f6810] Posters
const struct Animation anim_concert_hall_poster[] = {
