...
struct Animation results_level_anim00[] = {
    /* 000 */ { results_level_cel000, 4 },
    /* End */ END_ANIMATION
};

// [D_0890b6bc] Result Icon { 0 = OK; 1 = Try Again; 2 = Superb }
struct Animation results_level_anim01[] = {
...
// [D_0890b724] "‚Å‚à" ("but")
struct Animation results_level_anim06[] = {
