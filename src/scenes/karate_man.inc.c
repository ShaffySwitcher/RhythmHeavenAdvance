...
void func_0802139c(u32 arg0, u32 arg1) {
    ...
    func_0800e030(0);
    D_030055d0->unk32 = func_0800c3a4(arg1 + 1);
}
...
void func_08021440(u32 arg0) {
	func_0800aa4c(D_030055d0->unk24, arg0);

}

void func_08021458(void) {
    func_0804cebc(D_03005380, D_030055d0->unk28, 0);
    func_0804d770(D_03005380, D_030055d0->unk28, 1);
    func_08017338(0, 0);
    func_0800bd04(1);
    D_030055d0->unk2A = 1;
}
...
void func_080214d4(u32 arg0) {
    D_030055d0->unk30 = arg0;
    if (arg0) {
        func_0804d770(D_03005380, D_030055d0->unk2E, 1);
        func_0804cebc(D_03005380, D_030055d0->unk2E, arg0);
    } else {
        func_0804d770(D_03005380, D_030055d0->unk2E, 0);
    }
}
...
void func_08021544(u8 arg0) {
	D_030055d0->unk36 = arg0;
}

void func_08021554(void) {
    if (D_030055d0->unk2A) {
        if (D_03004afc & 1) {
            func_0804d770(D_03005380, D_030055d0->unk28, 0);
            func_08017338(1, 0);
            func_0800bd04(0);
            D_030055d0->unk2A = 0;
        }
    }
    func_08021e58(&D_030055d0->unk4);
    if (D_030055d0->unk0) {
        if (D_030055d0->unk0 == 1) {
            func_080213e4();
        }
    }
    func_0800a914(D_030055d0->unk24);
}

void func_080215cc(void) {
    func_08021e40(&D_030055d0->unk4);
    func_0804d504(D_03005380, D_030055d0->unk20);
    func_0804d504(D_03005380, D_030055d0->unk14);
    func_0800e044(0);
    func_0800e044(1);
}
...
void func_080219a8(void) {
    ...
    D_030055d0->unk34 = 0;
    func_0804d8c4(D_03005380, D_030055d0->unk8, 1);
    func_0800e030(0);
    func_0800e044(1);
    func_0804d770(D_03005380, D_030055d0->unk14, 0);
    D_030055d0->unk0 = 2;
    func_0800c128(0);
    temp = 0x100;
...
void func_08021a0c(void) {
    D_030055d0->unk35 = 0;
    func_0804d8c4(D_03005380, D_030055d0->unk8, 0);
    func_0800e044(0);
    func_0800e030(1);
    func_0804d770(D_03005380, D_030055d0->unk14, 1);
    D_030055d0->unk0 = 0;
    func_080221cc();
    func_080173c4(0);
}
...
void func_08021d38(u32 arg0, struct struct_030055d0_sub *arg1) {
    u32 temp;
    struct struct_030055d0_sub *temp1;
    temp1 = &D_030055d0->unk4;
    temp = 0;
    if (D_030055d0->unk0 == 1) {
        temp = 1;
    }
...
void func_08021dd8(struct struct_030055d0_sub *arg0) {
    arg0->unk0 = 0;
...
void func_08021e40(struct struct_030055d0_sub *arg0) {
	func_0804d504(D_03005380, arg0->unk4);
}


void func_08021e58(struct struct_030055d0_sub *arg0) {
...
void func_08021e88(void) {
    struct struct_030055d0_sub *temp;
    temp = &D_030055d0->unk4;

    temp->unk0 = 0 | 1;
    if (D_030055d0->unk16 < 3) {
...
void func_08022010(u32 arg0) {
    func_0804d770(D_03005380, D_030055d0->unk20, arg0 != 0);
    if (arg0) {
        func_0804cebc(D_03005380, D_030055d0->unk20, arg0 - 1);
    }
}
...
void func_08022050(void) {
    ...
    D_030055d0->unk16 = 0;
    temp = func_0804d160(D_03005380, D_088acd1c, D_030055d0->unk16, 0x24, 0x10, 0x47f6, 0, 0, 0);
    D_030055d0->unk14 = temp;
    D_030055d0->unk17 = 1;
    if (D_030055d0->unk0 == 2) {
        func_0804d770(D_03005380, D_030055d0->unk14, 0);
        D_030055d0->unk17 = 0;
    ...
    D_030055d0->unk18 = 0;
    D_030055d0->unk1C = D_089df37c;
}

void func_080220c4(void) {
    if (D_030055d0->unk16 > 2) {
        func_08002634(&s_f_boxing_score_reset_seqData);
    }
    D_030055d0->unk16 = 0;
    func_0804cebc(D_03005380, D_030055d0->unk14, D_030055d0->unk16);
    D_030055d0->unk18 = 0;
    D_030055d0->unk1C = D_089df37c;
    func_080221cc();
}
...
void func_08022114(void) {
    if (D_030055d0->unk17) {
        if (D_030055d0->unk16 <= 4) {
            D_030055d0->unk16++;
            func_0804cebc(D_03005380, D_030055d0->unk14, D_030055d0->unk16);
            if (D_030055d0->unk16 == 3) {
                D_030055d0->unk18 = 0;
                D_030055d0->unk1C = D_089df37e;
                func_080221cc();
...
void func_0802221c(u32 arg0) {
    D_030055d0->unk17 = arg0;
    func_0804d770(D_03005380, D_030055d0->unk14, arg0);
}
